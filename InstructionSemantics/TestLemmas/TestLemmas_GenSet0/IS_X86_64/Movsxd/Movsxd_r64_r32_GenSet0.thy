...
theory Movsxd_r64_r32_GenSet0
  imports Movsxd_Setup_GenSet0 Movsxd_r64_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale movsxd_r64_r32_test = execution_context + strata_rules_movsxd
begin
...
lemma is_manual_movsxd_r64_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_X86_64 Movsxd) (Reg (General  SixtyFour r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
