...
theory Blsr_r32_r32_GenSet0
  imports Blsr_Setup_GenSet0 Blsr_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale blsr_r32_r32_test = execution_context + strata_rules_blsr
begin
...
lemma is_manual_blsr_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_BM1_BM2 Blsr) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
