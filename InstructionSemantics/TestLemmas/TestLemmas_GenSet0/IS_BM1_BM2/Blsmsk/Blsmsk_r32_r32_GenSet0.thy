...
theory Blsmsk_r32_r32_GenSet0
  imports Blsmsk_Setup_GenSet0 Blsmsk_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale blsmsk_r32_r32_test = execution_context + strata_rules_blsmsk
begin
...
lemma is_manual_blsmsk_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_BM1_BM2 Blsmsk) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
