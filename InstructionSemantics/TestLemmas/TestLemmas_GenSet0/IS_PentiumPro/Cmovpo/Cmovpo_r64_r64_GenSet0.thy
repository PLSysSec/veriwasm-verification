...
theory Cmovpo_r64_r64_GenSet0
  imports Cmovpo_Setup_GenSet0 Cmovpo_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovpo_r64_r64_test = execution_context + strata_rules_cmovpo
begin
...
lemma is_manual_cmovpo_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovpo) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
