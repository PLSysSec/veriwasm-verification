...
theory Cmovpo_r32_r32_GenSet0
  imports Cmovpo_Setup_GenSet0 Cmovpo_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovpo_r32_r32_test = execution_context + strata_rules_cmovpo
begin
...
lemma is_manual_cmovpo_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovpo) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
