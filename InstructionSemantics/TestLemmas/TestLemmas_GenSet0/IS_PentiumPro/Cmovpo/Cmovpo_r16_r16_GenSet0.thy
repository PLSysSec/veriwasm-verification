...
theory Cmovpo_r16_r16_GenSet0
  imports Cmovpo_Setup_GenSet0 Cmovpo_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovpo_r16_r16_test = execution_context + strata_rules_cmovpo
begin
...
lemma is_manual_cmovpo_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovpo) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
