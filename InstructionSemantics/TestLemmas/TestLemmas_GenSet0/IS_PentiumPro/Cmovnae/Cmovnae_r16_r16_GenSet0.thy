...
theory Cmovnae_r16_r16_GenSet0
  imports Cmovnae_Setup_GenSet0 Cmovnae_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovnae_r16_r16_test = execution_context + strata_rules_cmovnae
begin
...
lemma is_manual_cmovnae_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovnae) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
  by (auto simp add: is_manual_def Let'_def simp_rules unfold_semantics)

abbreviation Instr   where "Instr      \<equiv> r_r_Instr"
abbreviation RegDstSize where "RegDstSize \<equiv> Sixteen"
abbreviation RegSrcSize where "RegSrcSize \<equiv> Sixteen"
