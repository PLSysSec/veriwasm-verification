...
theory Cmovnp_r64_r64_GenSet0
  imports Cmovnp_Setup_GenSet0 Cmovnp_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovnp_r64_r64_test = execution_context + strata_rules_cmovnp
begin
...
lemma is_manual_cmovnp_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovnp) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
