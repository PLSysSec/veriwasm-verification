...
theory Cmovnp_r16_r16_GenSet0
  imports Cmovnp_Setup_GenSet0 Cmovnp_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovnp_r16_r16_test = execution_context + strata_rules_cmovnp
begin
...
lemma is_manual_cmovnp_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovnp) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
