...
theory Cmovnp_r32_r32_GenSet0
  imports Cmovnp_Setup_GenSet0 Cmovnp_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovnp_r32_r32_test = execution_context + strata_rules_cmovnp
begin
...
lemma is_manual_cmovnp_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovnp) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
