...
theory Cmovl_r32_r32_GenSet0
  imports Cmovl_Setup_GenSet0 Cmovl_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovl_r32_r32_test = execution_context + strata_rules_cmovl
begin
...
lemma is_manual_cmovl_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovl) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
