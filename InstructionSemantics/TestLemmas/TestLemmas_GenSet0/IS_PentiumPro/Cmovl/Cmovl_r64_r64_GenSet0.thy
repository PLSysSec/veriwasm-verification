...
theory Cmovl_r64_r64_GenSet0
  imports Cmovl_Setup_GenSet0 Cmovl_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovl_r64_r64_test = execution_context + strata_rules_cmovl
begin
...
lemma is_manual_cmovl_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovl) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
