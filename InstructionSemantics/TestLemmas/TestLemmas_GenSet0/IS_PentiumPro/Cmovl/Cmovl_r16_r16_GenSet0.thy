...
theory Cmovl_r16_r16_GenSet0
  imports Cmovl_Setup_GenSet0 Cmovl_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovl_r16_r16_test = execution_context + strata_rules_cmovl
begin
...
lemma is_manual_cmovl_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovl) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
