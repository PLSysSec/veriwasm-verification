...
theory Cmovae_r16_r16_GenSet0
  imports Cmovae_Setup_GenSet0 Cmovae_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovae_r16_r16_test = execution_context + strata_rules_cmovae
begin
...
lemma is_manual_cmovae_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovae) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
