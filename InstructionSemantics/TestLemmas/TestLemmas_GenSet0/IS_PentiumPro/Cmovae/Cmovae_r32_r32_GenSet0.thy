...
theory Cmovae_r32_r32_GenSet0
  imports Cmovae_Setup_GenSet0 Cmovae_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovae_r32_r32_test = execution_context + strata_rules_cmovae
begin
...
lemma is_manual_cmovae_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovae) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
