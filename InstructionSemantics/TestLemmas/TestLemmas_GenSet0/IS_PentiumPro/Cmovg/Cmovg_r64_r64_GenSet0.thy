...
theory Cmovg_r64_r64_GenSet0
  imports Cmovg_Setup_GenSet0 Cmovg_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovg_r64_r64_test = execution_context + strata_rules_cmovg
begin
...
lemma is_manual_cmovg_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovg) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
