...
theory Cmovg_r32_r32_GenSet0
  imports Cmovg_Setup_GenSet0 Cmovg_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovg_r32_r32_test = execution_context + strata_rules_cmovg
begin
...
lemma is_manual_cmovg_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovg) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
