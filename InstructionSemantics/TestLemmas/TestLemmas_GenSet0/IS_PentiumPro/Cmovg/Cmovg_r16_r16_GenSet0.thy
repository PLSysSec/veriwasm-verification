...
theory Cmovg_r16_r16_GenSet0
  imports Cmovg_Setup_GenSet0 Cmovg_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovg_r16_r16_test = execution_context + strata_rules_cmovg
begin
...
lemma is_manual_cmovg_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovg) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
