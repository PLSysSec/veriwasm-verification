...
theory Cmovp_r64_r64_GenSet0
  imports Cmovp_Setup_GenSet0 Cmovp_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovp_r64_r64_test = execution_context + strata_rules_cmovp
begin
...
lemma is_manual_cmovp_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovp) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
