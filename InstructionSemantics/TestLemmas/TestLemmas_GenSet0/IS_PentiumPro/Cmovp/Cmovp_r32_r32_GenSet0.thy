...
theory Cmovp_r32_r32_GenSet0
  imports Cmovp_Setup_GenSet0 Cmovp_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovp_r32_r32_test = execution_context + strata_rules_cmovp
begin
...
lemma is_manual_cmovp_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovp) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
