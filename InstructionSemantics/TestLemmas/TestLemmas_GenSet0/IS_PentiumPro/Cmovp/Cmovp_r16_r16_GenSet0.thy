...
theory Cmovp_r16_r16_GenSet0
  imports Cmovp_Setup_GenSet0 Cmovp_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovp_r16_r16_test = execution_context + strata_rules_cmovp
begin
...
lemma is_manual_cmovp_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovp) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
