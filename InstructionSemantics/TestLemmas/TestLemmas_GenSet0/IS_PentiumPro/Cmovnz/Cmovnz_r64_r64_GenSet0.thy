...
theory Cmovnz_r64_r64_GenSet0
  imports Cmovnz_Setup_GenSet0 Cmovnz_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovnz_r64_r64_test = execution_context + strata_rules_cmovnz
begin
...
lemma is_manual_cmovnz_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovnz) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
