...
theory Cmovnz_r32_r32_GenSet0
  imports Cmovnz_Setup_GenSet0 Cmovnz_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovnz_r32_r32_test = execution_context + strata_rules_cmovnz
begin
...
lemma is_manual_cmovnz_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovnz) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
