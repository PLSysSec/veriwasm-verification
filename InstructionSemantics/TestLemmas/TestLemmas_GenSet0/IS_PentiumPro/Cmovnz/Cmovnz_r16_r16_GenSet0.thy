...
theory Cmovnz_r16_r16_GenSet0
  imports Cmovnz_Setup_GenSet0 Cmovnz_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovnz_r16_r16_test = execution_context + strata_rules_cmovnz
begin
...
lemma is_manual_cmovnz_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovnz) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
