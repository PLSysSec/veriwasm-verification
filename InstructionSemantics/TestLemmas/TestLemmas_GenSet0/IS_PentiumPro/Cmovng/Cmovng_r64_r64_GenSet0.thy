...
theory Cmovng_r64_r64_GenSet0
  imports Cmovng_Setup_GenSet0 Cmovng_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovng_r64_r64_test = execution_context + strata_rules_cmovng
begin
...
lemma is_manual_cmovng_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovng) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
