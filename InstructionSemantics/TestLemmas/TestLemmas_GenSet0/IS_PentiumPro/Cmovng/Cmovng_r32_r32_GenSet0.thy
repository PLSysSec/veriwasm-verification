...
theory Cmovng_r32_r32_GenSet0
  imports Cmovng_Setup_GenSet0 Cmovng_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovng_r32_r32_test = execution_context + strata_rules_cmovng
begin
...
lemma is_manual_cmovng_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovng) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
