...
theory Cmovng_r16_r16_GenSet0
  imports Cmovng_Setup_GenSet0 Cmovng_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovng_r16_r16_test = execution_context + strata_rules_cmovng
begin
...
lemma is_manual_cmovng_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovng) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
