...
theory Cmovnbe_r64_r64_GenSet0
  imports Cmovnbe_Setup_GenSet0 Cmovnbe_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovnbe_r64_r64_test = execution_context + strata_rules_cmovnbe
begin
...
lemma is_manual_cmovnbe_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovnbe) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
