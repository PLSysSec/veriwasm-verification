...
theory Cmovnbe_r16_r16_GenSet0
  imports Cmovnbe_Setup_GenSet0 Cmovnbe_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovnbe_r16_r16_test = execution_context + strata_rules_cmovnbe
begin
...
lemma is_manual_cmovnbe_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovnbe) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
