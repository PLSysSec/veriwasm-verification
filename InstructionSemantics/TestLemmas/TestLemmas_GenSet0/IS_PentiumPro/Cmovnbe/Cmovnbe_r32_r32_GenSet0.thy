...
theory Cmovnbe_r32_r32_GenSet0
  imports Cmovnbe_Setup_GenSet0 Cmovnbe_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovnbe_r32_r32_test = execution_context + strata_rules_cmovnbe
begin
...
lemma is_manual_cmovnbe_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovnbe) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
