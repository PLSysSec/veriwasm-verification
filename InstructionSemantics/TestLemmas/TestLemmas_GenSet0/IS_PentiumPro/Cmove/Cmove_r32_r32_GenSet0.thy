...
theory Cmove_r32_r32_GenSet0
  imports Cmove_Setup_GenSet0 Cmove_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmove_r32_r32_test = execution_context + strata_rules_cmove
begin
...
lemma is_manual_cmove_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmove) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
