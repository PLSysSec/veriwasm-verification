...
theory Cmove_r16_r16_GenSet0
  imports Cmove_Setup_GenSet0 Cmove_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmove_r16_r16_test = execution_context + strata_rules_cmove
begin
...
lemma is_manual_cmove_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmove) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
