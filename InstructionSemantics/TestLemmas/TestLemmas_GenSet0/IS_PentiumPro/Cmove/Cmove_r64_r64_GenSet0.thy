...
theory Cmove_r64_r64_GenSet0
  imports Cmove_Setup_GenSet0 Cmove_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmove_r64_r64_test = execution_context + strata_rules_cmove
begin
...
lemma is_manual_cmove_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmove) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
