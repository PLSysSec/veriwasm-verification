...
theory Cmova_r16_r16_GenSet0
  imports Cmova_Setup_GenSet0 Cmova_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmova_r16_r16_test = execution_context + strata_rules_cmova
begin
...
lemma is_manual_cmova_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmova) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
