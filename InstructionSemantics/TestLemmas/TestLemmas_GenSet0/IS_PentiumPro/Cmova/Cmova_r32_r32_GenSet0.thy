...
theory Cmova_r32_r32_GenSet0
  imports Cmova_Setup_GenSet0 Cmova_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmova_r32_r32_test = execution_context + strata_rules_cmova
begin
...
lemma is_manual_cmova_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmova) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
