...
theory Cmovs_r32_r32_GenSet0
  imports Cmovs_Setup_GenSet0 Cmovs_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovs_r32_r32_test = execution_context + strata_rules_cmovs
begin
...
lemma is_manual_cmovs_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovs) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
