...
theory Cmovs_r16_r16_GenSet0
  imports Cmovs_Setup_GenSet0 Cmovs_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovs_r16_r16_test = execution_context + strata_rules_cmovs
begin
...
lemma is_manual_cmovs_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovs) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
