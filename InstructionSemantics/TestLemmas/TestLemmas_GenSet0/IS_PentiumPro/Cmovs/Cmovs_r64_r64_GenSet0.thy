...
theory Cmovs_r64_r64_GenSet0
  imports Cmovs_Setup_GenSet0 Cmovs_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovs_r64_r64_test = execution_context + strata_rules_cmovs
begin
...
lemma is_manual_cmovs_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovs) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
