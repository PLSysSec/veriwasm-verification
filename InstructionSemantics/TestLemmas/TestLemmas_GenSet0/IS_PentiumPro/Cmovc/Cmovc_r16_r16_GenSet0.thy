...
theory Cmovc_r16_r16_GenSet0
  imports Cmovc_Setup_GenSet0 Cmovc_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovc_r16_r16_test = execution_context + strata_rules_cmovc
begin
...
lemma is_manual_cmovc_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovc) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
