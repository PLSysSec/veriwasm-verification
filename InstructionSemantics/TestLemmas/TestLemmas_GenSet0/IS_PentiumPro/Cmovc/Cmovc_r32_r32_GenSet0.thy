...
theory Cmovc_r32_r32_GenSet0
  imports Cmovc_Setup_GenSet0 Cmovc_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovc_r32_r32_test = execution_context + strata_rules_cmovc
begin
...
lemma is_manual_cmovc_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovc) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
