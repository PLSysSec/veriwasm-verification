...
theory Cmovc_r64_r64_GenSet0
  imports Cmovc_Setup_GenSet0 Cmovc_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovc_r64_r64_test = execution_context + strata_rules_cmovc
begin
...
lemma is_manual_cmovc_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovc) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
