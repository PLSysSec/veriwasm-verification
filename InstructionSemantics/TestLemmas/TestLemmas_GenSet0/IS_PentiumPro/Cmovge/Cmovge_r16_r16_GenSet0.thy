...
theory Cmovge_r16_r16_GenSet0
  imports Cmovge_Setup_GenSet0 Cmovge_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovge_r16_r16_test = execution_context + strata_rules_cmovge
begin
...
lemma is_manual_cmovge_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovge) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
