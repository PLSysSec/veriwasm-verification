...
theory Cmovge_r32_r32_GenSet0
  imports Cmovge_Setup_GenSet0 Cmovge_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovge_r32_r32_test = execution_context + strata_rules_cmovge
begin
...
lemma is_manual_cmovge_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovge) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
