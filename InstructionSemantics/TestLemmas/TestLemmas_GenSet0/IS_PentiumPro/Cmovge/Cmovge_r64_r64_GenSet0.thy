...
theory Cmovge_r64_r64_GenSet0
  imports Cmovge_Setup_GenSet0 Cmovge_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovge_r64_r64_test = execution_context + strata_rules_cmovge
begin
...
lemma is_manual_cmovge_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovge) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
