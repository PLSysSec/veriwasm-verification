...
theory Cmovnc_r64_r64_GenSet0
  imports Cmovnc_Setup_GenSet0 Cmovnc_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovnc_r64_r64_test = execution_context + strata_rules_cmovnc
begin
...
lemma is_manual_cmovnc_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovnc) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
