...
theory Cmovnc_r32_r32_GenSet0
  imports Cmovnc_Setup_GenSet0 Cmovnc_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovnc_r32_r32_test = execution_context + strata_rules_cmovnc
begin
...
lemma is_manual_cmovnc_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovnc) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
