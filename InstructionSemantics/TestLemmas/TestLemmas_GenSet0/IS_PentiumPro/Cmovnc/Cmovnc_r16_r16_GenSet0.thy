...
theory Cmovnc_r16_r16_GenSet0
  imports Cmovnc_Setup_GenSet0 Cmovnc_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovnc_r16_r16_test = execution_context + strata_rules_cmovnc
begin
...
lemma is_manual_cmovnc_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovnc) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
