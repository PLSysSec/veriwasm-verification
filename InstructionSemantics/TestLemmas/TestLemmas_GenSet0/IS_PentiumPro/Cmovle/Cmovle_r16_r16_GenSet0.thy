...
theory Cmovle_r16_r16_GenSet0
  imports Cmovle_Setup_GenSet0 Cmovle_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovle_r16_r16_test = execution_context + strata_rules_cmovle
begin
...
lemma is_manual_cmovle_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovle) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
