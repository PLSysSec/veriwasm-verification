...
theory Cmovo_r32_r32_GenSet0
  imports Cmovo_Setup_GenSet0 Cmovo_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovo_r32_r32_test = execution_context + strata_rules_cmovo
begin
...
lemma is_manual_cmovo_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovo) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
