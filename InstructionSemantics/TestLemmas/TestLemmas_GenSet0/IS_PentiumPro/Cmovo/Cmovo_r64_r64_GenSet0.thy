...
theory Cmovo_r64_r64_GenSet0
  imports Cmovo_Setup_GenSet0 Cmovo_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovo_r64_r64_test = execution_context + strata_rules_cmovo
begin
...
lemma is_manual_cmovo_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovo) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
