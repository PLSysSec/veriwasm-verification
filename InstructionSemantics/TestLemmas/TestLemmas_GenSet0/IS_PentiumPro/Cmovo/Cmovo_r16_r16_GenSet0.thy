...
theory Cmovo_r16_r16_GenSet0
  imports Cmovo_Setup_GenSet0 Cmovo_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovo_r16_r16_test = execution_context + strata_rules_cmovo
begin
...
lemma is_manual_cmovo_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovo) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
