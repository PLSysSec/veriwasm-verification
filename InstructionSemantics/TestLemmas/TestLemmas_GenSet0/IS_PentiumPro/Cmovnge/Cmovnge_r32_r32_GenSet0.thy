...
theory Cmovnge_r32_r32_GenSet0
  imports Cmovnge_Setup_GenSet0 Cmovnge_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovnge_r32_r32_test = execution_context + strata_rules_cmovnge
begin
...
lemma is_manual_cmovnge_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovnge) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
