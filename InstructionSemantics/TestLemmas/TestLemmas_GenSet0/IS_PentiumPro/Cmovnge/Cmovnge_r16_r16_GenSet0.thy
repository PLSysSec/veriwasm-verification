...
theory Cmovnge_r16_r16_GenSet0
  imports Cmovnge_Setup_GenSet0 Cmovnge_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovnge_r16_r16_test = execution_context + strata_rules_cmovnge
begin
...
lemma is_manual_cmovnge_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovnge) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
