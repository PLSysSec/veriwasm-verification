...
theory Cmovnl_r64_r64_GenSet0
  imports Cmovnl_Setup_GenSet0 Cmovnl_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovnl_r64_r64_test = execution_context + strata_rules_cmovnl
begin
...
lemma is_manual_cmovnl_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovnl) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
