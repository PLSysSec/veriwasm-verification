...
theory Cmovnl_r16_r16_GenSet0
  imports Cmovnl_Setup_GenSet0 Cmovnl_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovnl_r16_r16_test = execution_context + strata_rules_cmovnl
begin
...
lemma is_manual_cmovnl_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovnl) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
