...
theory Cmovnl_r32_r32_GenSet0
  imports Cmovnl_Setup_GenSet0 Cmovnl_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovnl_r32_r32_test = execution_context + strata_rules_cmovnl
begin
...
lemma is_manual_cmovnl_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovnl) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
