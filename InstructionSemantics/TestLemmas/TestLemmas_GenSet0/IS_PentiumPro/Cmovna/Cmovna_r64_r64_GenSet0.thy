...
theory Cmovna_r64_r64_GenSet0
  imports Cmovna_Setup_GenSet0 Cmovna_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovna_r64_r64_test = execution_context + strata_rules_cmovna
begin
...
lemma is_manual_cmovna_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovna) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
