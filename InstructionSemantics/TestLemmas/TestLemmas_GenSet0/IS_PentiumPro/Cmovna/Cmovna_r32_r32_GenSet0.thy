...
theory Cmovna_r32_r32_GenSet0
  imports Cmovna_Setup_GenSet0 Cmovna_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovna_r32_r32_test = execution_context + strata_rules_cmovna
begin
...
lemma is_manual_cmovna_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovna) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
