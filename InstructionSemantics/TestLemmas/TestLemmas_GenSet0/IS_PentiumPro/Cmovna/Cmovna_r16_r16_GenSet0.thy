...
theory Cmovna_r16_r16_GenSet0
  imports Cmovna_Setup_GenSet0 Cmovna_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovna_r16_r16_test = execution_context + strata_rules_cmovna
begin
...
lemma is_manual_cmovna_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovna) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
