...
theory Cmovpe_r64_r64_GenSet0
  imports Cmovpe_Setup_GenSet0 Cmovpe_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovpe_r64_r64_test = execution_context + strata_rules_cmovpe
begin
...
lemma is_manual_cmovpe_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovpe) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
