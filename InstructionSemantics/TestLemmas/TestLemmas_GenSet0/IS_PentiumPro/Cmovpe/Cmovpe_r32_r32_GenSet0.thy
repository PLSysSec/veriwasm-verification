...
theory Cmovpe_r32_r32_GenSet0
  imports Cmovpe_Setup_GenSet0 Cmovpe_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovpe_r32_r32_test = execution_context + strata_rules_cmovpe
begin
...
lemma is_manual_cmovpe_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovpe) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
