...
theory Cmovpe_r16_r16_GenSet0
  imports Cmovpe_Setup_GenSet0 Cmovpe_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovpe_r16_r16_test = execution_context + strata_rules_cmovpe
begin
...
lemma is_manual_cmovpe_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovpe) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
