...
theory Cmovno_r16_r16_GenSet0
  imports Cmovno_Setup_GenSet0 Cmovno_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovno_r16_r16_test = execution_context + strata_rules_cmovno
begin
...
lemma is_manual_cmovno_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovno) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
