...
theory Cmovno_r32_r32_GenSet0
  imports Cmovno_Setup_GenSet0 Cmovno_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovno_r32_r32_test = execution_context + strata_rules_cmovno
begin
...
lemma is_manual_cmovno_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovno) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
