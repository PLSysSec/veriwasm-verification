...
theory Cmovno_r64_r64_GenSet0
  imports Cmovno_Setup_GenSet0 Cmovno_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovno_r64_r64_test = execution_context + strata_rules_cmovno
begin
...
lemma is_manual_cmovno_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovno) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
