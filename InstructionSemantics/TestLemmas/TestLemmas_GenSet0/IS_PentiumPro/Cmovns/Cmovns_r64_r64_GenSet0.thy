...
theory Cmovns_r64_r64_GenSet0
  imports Cmovns_Setup_GenSet0 Cmovns_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovns_r64_r64_test = execution_context + strata_rules_cmovns
begin
...
lemma is_manual_cmovns_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovns) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
