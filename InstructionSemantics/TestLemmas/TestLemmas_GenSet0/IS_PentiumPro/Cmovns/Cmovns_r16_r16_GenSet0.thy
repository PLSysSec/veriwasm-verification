...
theory Cmovns_r16_r16_GenSet0
  imports Cmovns_Setup_GenSet0 Cmovns_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovns_r16_r16_test = execution_context + strata_rules_cmovns
begin
...
lemma is_manual_cmovns_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovns) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
