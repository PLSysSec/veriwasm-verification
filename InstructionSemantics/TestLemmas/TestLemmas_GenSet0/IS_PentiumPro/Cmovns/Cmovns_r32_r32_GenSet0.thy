...
theory Cmovns_r32_r32_GenSet0
  imports Cmovns_Setup_GenSet0 Cmovns_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovns_r32_r32_test = execution_context + strata_rules_cmovns
begin
...
lemma is_manual_cmovns_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovns) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
