...
theory Cmovz_r32_r32_GenSet0
  imports Cmovz_Setup_GenSet0 Cmovz_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovz_r32_r32_test = execution_context + strata_rules_cmovz
begin
...
lemma is_manual_cmovz_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovz) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
