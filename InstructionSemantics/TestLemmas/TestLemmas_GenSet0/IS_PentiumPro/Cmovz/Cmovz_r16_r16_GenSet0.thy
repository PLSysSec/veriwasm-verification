...
theory Cmovz_r16_r16_GenSet0
  imports Cmovz_Setup_GenSet0 Cmovz_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovz_r16_r16_test = execution_context + strata_rules_cmovz
begin
...
lemma is_manual_cmovz_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovz) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
