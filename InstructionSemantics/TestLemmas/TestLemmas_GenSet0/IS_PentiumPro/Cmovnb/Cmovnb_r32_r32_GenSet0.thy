...
theory Cmovnb_r32_r32_GenSet0
  imports Cmovnb_Setup_GenSet0 Cmovnb_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovnb_r32_r32_test = execution_context + strata_rules_cmovnb
begin
...
lemma is_manual_cmovnb_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovnb) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
