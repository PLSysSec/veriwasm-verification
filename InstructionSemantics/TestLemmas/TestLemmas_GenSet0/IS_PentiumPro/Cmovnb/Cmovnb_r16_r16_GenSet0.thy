...
theory Cmovnb_r16_r16_GenSet0
  imports Cmovnb_Setup_GenSet0 Cmovnb_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovnb_r16_r16_test = execution_context + strata_rules_cmovnb
begin
...
lemma is_manual_cmovnb_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovnb) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
