...
theory Cmovnb_r64_r64_GenSet0
  imports Cmovnb_Setup_GenSet0 Cmovnb_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovnb_r64_r64_test = execution_context + strata_rules_cmovnb
begin
...
lemma is_manual_cmovnb_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovnb) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
