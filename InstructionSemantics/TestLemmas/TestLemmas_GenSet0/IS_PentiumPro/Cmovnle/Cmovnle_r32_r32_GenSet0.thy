...
theory Cmovnle_r32_r32_GenSet0
  imports Cmovnle_Setup_GenSet0 Cmovnle_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovnle_r32_r32_test = execution_context + strata_rules_cmovnle
begin
...
lemma is_manual_cmovnle_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovnle) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
