...
theory Cmovnle_r16_r16_GenSet0
  imports Cmovnle_Setup_GenSet0 Cmovnle_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovnle_r16_r16_test = execution_context + strata_rules_cmovnle
begin
...
lemma is_manual_cmovnle_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovnle) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
