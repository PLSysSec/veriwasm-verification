...
theory Cmovnle_r64_r64_GenSet0
  imports Cmovnle_Setup_GenSet0 Cmovnle_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovnle_r64_r64_test = execution_context + strata_rules_cmovnle
begin
...
lemma is_manual_cmovnle_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovnle) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
  by (auto simp add: is_manual_def Let'_def simp_rules unfold_semantics)

abbreviation Instr   where "Instr      \<equiv> r_r_Instr"
abbreviation RegDstSize where "RegDstSize \<equiv> SixtyFour"
abbreviation RegSrcSize where "RegSrcSize \<equiv> SixtyFour"
