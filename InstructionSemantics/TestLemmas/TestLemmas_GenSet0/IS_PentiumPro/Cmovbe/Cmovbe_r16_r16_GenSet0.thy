...
theory Cmovbe_r16_r16_GenSet0
  imports Cmovbe_Setup_GenSet0 Cmovbe_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovbe_r16_r16_test = execution_context + strata_rules_cmovbe
begin
...
lemma is_manual_cmovbe_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovbe) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
