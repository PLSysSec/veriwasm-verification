...
theory Cmovbe_r32_r32_GenSet0
  imports Cmovbe_Setup_GenSet0 Cmovbe_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovbe_r32_r32_test = execution_context + strata_rules_cmovbe
begin
...
lemma is_manual_cmovbe_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovbe) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
