...
theory Cmovbe_r64_r64_GenSet0
  imports Cmovbe_Setup_GenSet0 Cmovbe_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovbe_r64_r64_test = execution_context + strata_rules_cmovbe
begin
...
lemma is_manual_cmovbe_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovbe) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
