...
theory Cmovne_r64_r64_GenSet0
  imports Cmovne_Setup_GenSet0 Cmovne_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovne_r64_r64_test = execution_context + strata_rules_cmovne
begin
...
lemma is_manual_cmovne_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovne) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
