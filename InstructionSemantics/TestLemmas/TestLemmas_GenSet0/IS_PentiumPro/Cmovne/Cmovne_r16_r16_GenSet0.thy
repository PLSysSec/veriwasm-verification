...
theory Cmovne_r16_r16_GenSet0
  imports Cmovne_Setup_GenSet0 Cmovne_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovne_r16_r16_test = execution_context + strata_rules_cmovne
begin
...
lemma is_manual_cmovne_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovne) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
