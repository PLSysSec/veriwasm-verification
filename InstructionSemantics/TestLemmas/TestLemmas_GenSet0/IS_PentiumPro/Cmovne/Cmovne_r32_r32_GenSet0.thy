...
theory Cmovne_r32_r32_GenSet0
  imports Cmovne_Setup_GenSet0 Cmovne_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovne_r32_r32_test = execution_context + strata_rules_cmovne
begin
...
lemma is_manual_cmovne_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovne) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
