...
theory Cmovb_r64_r64_GenSet0
  imports Cmovb_Setup_GenSet0 Cmovb_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovb_r64_r64_test = execution_context + strata_rules_cmovb
begin
...
lemma is_manual_cmovb_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovb) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
