...
theory Cmovb_r32_r32_GenSet0
  imports Cmovb_Setup_GenSet0 Cmovb_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovb_r32_r32_test = execution_context + strata_rules_cmovb
begin
...
lemma is_manual_cmovb_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovb) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
