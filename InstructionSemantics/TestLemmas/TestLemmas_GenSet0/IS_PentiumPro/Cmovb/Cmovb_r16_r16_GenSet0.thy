...
theory Cmovb_r16_r16_GenSet0
  imports Cmovb_Setup_GenSet0 Cmovb_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmovb_r16_r16_test = execution_context + strata_rules_cmovb
begin
...
lemma is_manual_cmovb_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_PentiumPro Cmovb) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
