...
theory Or_r32_r32_GenSet0
  imports Or_Setup_GenSet0 Or_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale or_r32_r32_test = execution_context + strata_rules_or
begin
...
lemma is_manual_or_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Or) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
