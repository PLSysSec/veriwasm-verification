...
theory Or_rh_rh_GenSet0
  imports Or_Setup_GenSet0 Or_rh_rh_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale or_rh_rh_test = execution_context + strata_rules_or
begin
...
lemma is_manual_or_rh_rh [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Or) (Reg (General  EightHigh r_1)) (Storage (Reg (General EightHigh r_2)))) = False"
