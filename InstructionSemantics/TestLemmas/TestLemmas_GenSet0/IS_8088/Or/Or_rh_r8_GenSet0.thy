...
theory Or_rh_r8_GenSet0
  imports Or_Setup_GenSet0 Or_rh_r8_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale or_rh_r8_test = execution_context + strata_rules_or
begin
...
lemma is_manual_or_rh_r8 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Or) (Reg (General  EightHigh r_1)) (Storage (Reg (General EightLow r_2)))) = False"
