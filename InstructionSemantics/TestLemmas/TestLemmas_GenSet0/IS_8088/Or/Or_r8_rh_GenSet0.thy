...
theory Or_r8_rh_GenSet0
  imports Or_Setup_GenSet0 Or_r8_rh_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale or_r8_rh_test = execution_context + strata_rules_or
begin
...
lemma is_manual_or_r8_rh [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Or) (Reg (General  EightLow r_1)) (Storage (Reg (General EightHigh r_2)))) = False"
