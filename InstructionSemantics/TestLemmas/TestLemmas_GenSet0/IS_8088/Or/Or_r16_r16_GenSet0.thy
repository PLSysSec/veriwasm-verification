...
theory Or_r16_r16_GenSet0
  imports Or_Setup_GenSet0 Or_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale or_r16_r16_test = execution_context + strata_rules_or
begin
...
lemma is_manual_or_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Or) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
