...
theory Or_r64_r64_GenSet0
  imports Or_Setup_GenSet0 Or_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale or_r64_r64_test = execution_context + strata_rules_or
begin
...
lemma is_manual_or_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Or) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
