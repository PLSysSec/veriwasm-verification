...
theory Cmp_r8_rh_IOPairs_GenSet0
...
abbreviation Test3_flags_end :: "(flag \<times> bool) list" where "Test3_flags_end \<equiv> [(flag_cf, True),(flag_pf, undefined),(flag_zf, False),(flag_sf, True),(flag_of, True)]"
