...
theory Cmp_r32_r32_IOPairs_GenSet0
...
abbreviation Test1_flags_end :: "(flag \<times> bool) list" where "Test1_flags_end \<equiv> [(flag_cf, True),(flag_pf, undefined),(flag_zf, False),(flag_sf, True),(flag_of, False)]"
...
abbreviation Test3_flags_end :: "(flag \<times> bool) list" where "Test3_flags_end \<equiv> [(flag_cf, False),(flag_pf, undefined),(flag_zf, False),(flag_sf, False),(flag_of, True)]"
