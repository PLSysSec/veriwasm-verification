...
theory Cmp_r8_rh_GenSet0
  imports Cmp_Setup_GenSet0 Cmp_r8_rh_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmp_r8_rh_test = execution_context + strata_rules_cmp
begin
...
lemma is_manual_cmp_r8_rh [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Cmp) (Reg (General  EightLow r_1)) (Storage (Reg (General EightHigh r_2)))) = False"
