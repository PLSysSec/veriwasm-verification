...
theory Cmp_r64_r64_GenSet0
  imports Cmp_Setup_GenSet0 Cmp_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmp_r64_r64_test = execution_context + strata_rules_cmp
begin
...
lemma is_manual_cmp_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Cmp) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
