...
theory Cmp_r32_r32_GenSet0
  imports Cmp_Setup_GenSet0 Cmp_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmp_r32_r32_test = execution_context + strata_rules_cmp
begin
...
lemma is_manual_cmp_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Cmp) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
