...
theory Cmp_r16_r16_GenSet0
  imports Cmp_Setup_GenSet0 Cmp_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmp_r16_r16_test = execution_context + strata_rules_cmp
begin
...
lemma is_manual_cmp_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Cmp) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
