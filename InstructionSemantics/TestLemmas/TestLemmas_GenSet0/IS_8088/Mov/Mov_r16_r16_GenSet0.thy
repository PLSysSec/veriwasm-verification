...
theory Mov_r16_r16_GenSet0
  imports Mov_Setup_GenSet0 Mov_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale mov_r16_r16_test = execution_context + strata_rules_mov
begin
...
lemma is_manual_mov_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Mov) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
