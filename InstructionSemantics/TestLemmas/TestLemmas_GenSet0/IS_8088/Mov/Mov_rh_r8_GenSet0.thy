...
theory Mov_rh_r8_GenSet0
  imports Mov_Setup_GenSet0 Mov_rh_r8_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale mov_rh_r8_test = execution_context + strata_rules_mov
begin
...
lemma is_manual_mov_rh_r8 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Mov) (Reg (General  EightHigh r_1)) (Storage (Reg (General EightLow r_2)))) = False"
