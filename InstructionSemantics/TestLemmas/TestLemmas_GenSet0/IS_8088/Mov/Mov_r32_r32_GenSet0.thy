...
theory Mov_r32_r32_GenSet0
  imports Mov_Setup_GenSet0 Mov_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale mov_r32_r32_test = execution_context + strata_rules_mov
begin
...
lemma is_manual_mov_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Mov) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
