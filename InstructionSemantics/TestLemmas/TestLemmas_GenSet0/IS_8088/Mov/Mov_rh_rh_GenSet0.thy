...
theory Mov_rh_rh_GenSet0
  imports Mov_Setup_GenSet0 Mov_rh_rh_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale mov_rh_rh_test = execution_context + strata_rules_mov
begin
...
lemma is_manual_mov_rh_rh [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Mov) (Reg (General  EightHigh r_1)) (Storage (Reg (General EightHigh r_2)))) = False"
