...
theory Mov_r8_rh_GenSet0
  imports Mov_Setup_GenSet0 Mov_r8_rh_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale mov_r8_rh_test = execution_context + strata_rules_mov
begin
...
lemma is_manual_mov_r8_rh [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Mov) (Reg (General  EightLow r_1)) (Storage (Reg (General EightHigh r_2)))) = False"
