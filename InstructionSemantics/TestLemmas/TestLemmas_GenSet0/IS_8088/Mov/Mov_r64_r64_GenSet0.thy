...
theory Mov_r64_r64_GenSet0
  imports Mov_Setup_GenSet0 Mov_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale mov_r64_r64_test = execution_context + strata_rules_mov
begin
...
lemma is_manual_mov_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Mov) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
