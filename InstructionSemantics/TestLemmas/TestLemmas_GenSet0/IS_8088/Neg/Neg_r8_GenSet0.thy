...
theory Neg_r8_GenSet0
  imports Neg_Setup_GenSet0 Neg_r8_IOPairs_GenSet0
begin

locale neg_r8_test = execution_context + strata_rules_neg
begin
...
lemma is_manual_neg_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_8088 Neg)     (Storage (Reg (General EightLow r_1 )))) = False"
