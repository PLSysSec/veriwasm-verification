...
theory Neg_r32_GenSet0
  imports Neg_Setup_GenSet0 Neg_r32_IOPairs_GenSet0
begin

locale neg_r32_test = execution_context + strata_rules_neg
begin
...
lemma is_manual_neg_r32 [simp]:
  shows "is_manual assembly semantics (Unary (IS_8088 Neg)     (Storage (Reg (General ThirtyTwo r_1 )))) = False"
