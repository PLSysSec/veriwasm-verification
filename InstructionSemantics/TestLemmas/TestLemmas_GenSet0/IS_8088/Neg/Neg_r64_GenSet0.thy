...
theory Neg_r64_GenSet0
  imports Neg_Setup_GenSet0 Neg_r64_IOPairs_GenSet0
begin

locale neg_r64_test = execution_context + strata_rules_neg
begin
...
lemma is_manual_neg_r64 [simp]:
  shows "is_manual assembly semantics (Unary (IS_8088 Neg)     (Storage (Reg (General SixtyFour r_1 )))) = False"
