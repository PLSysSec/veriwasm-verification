...
theory Neg_r16_IOPairs_GenSet0
...
abbreviation Test1_dst_end :: "DstSize word list" where   "Test1_dst_end   \<equiv> [0xbf4ac1508d695663]" 
abbreviation Test1_src_start :: "SrcSize word list" where "Test1_src_start \<equiv> [0xbf4ac1508d69a99d]"
abbreviation Test1_src_end :: "SrcSize word list" where   "Test1_src_end   \<equiv> [0xbf4ac1508d695663]"
...
abbreviation Test1_flags_end :: "(flag \<times> bool) list" where "Test1_flags_end \<equiv> [(flag_cf, True),(flag_pf, True),(flag_zf, False),(flag_sf, False),(flag_of, False)]"
...
abbreviation Test2_dst_end :: "DstSize word list" where   "Test2_dst_end   \<equiv> [0xbdcf1da526976777]" 
abbreviation Test2_src_start :: "SrcSize word list" where "Test2_src_start \<equiv> [0xbdcf1da526979889]"
abbreviation Test2_src_end :: "SrcSize word list" where   "Test2_src_end   \<equiv> [0xbdcf1da526976777]"
...
abbreviation Test2_flags_end :: "(flag \<times> bool) list" where "Test2_flags_end \<equiv> [(flag_cf, True),(flag_pf, True),(flag_zf, False),(flag_sf, False),(flag_of, False)]"
...
abbreviation Test3_dst_end :: "DstSize word list" where   "Test3_dst_end   \<equiv> [0x56049a57ab5ecdc9]" 
abbreviation Test3_src_start :: "SrcSize word list" where "Test3_src_start \<equiv> [0x56049a57ab5e3237]"
abbreviation Test3_src_end :: "SrcSize word list" where   "Test3_src_end   \<equiv> [0x56049a57ab5ecdc9]"
...
abbreviation Test3_flags_end :: "(flag \<times> bool) list" where "Test3_flags_end \<equiv> [(flag_cf, True),(flag_pf, True),(flag_zf, False),(flag_sf, True),(flag_of, False)]"
...
abbreviation Test4_dst_end :: "DstSize word list" where   "Test4_dst_end   \<equiv> [0x38fe914348a1d7c8]" 
abbreviation Test4_src_start :: "SrcSize word list" where "Test4_src_start \<equiv> [0x38fe914348a12838]"
abbreviation Test4_src_end :: "SrcSize word list" where   "Test4_src_end   \<equiv> [0x38fe914348a1d7c8]"
...
abbreviation Test4_flags_end :: "(flag \<times> bool) list" where "Test4_flags_end \<equiv> [(flag_cf, True),(flag_pf, False),(flag_zf, False),(flag_sf, True),(flag_of, False)]"
...
abbreviation Test5_dst_end :: "DstSize word list" where   "Test5_dst_end   \<equiv> [0x98339fd3ba521fff]" 
abbreviation Test5_src_start :: "SrcSize word list" where "Test5_src_start \<equiv> [0x98339fd3ba52e001]"
abbreviation Test5_src_end :: "SrcSize word list" where   "Test5_src_end   \<equiv> [0x98339fd3ba521fff]"
...
abbreviation Test5_flags_end :: "(flag \<times> bool) list" where "Test5_flags_end \<equiv> [(flag_cf, True),(flag_pf, True),(flag_zf, False),(flag_sf, False),(flag_of, False)]"
