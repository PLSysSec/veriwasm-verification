...
theory Neg_r16_GenSet0
  imports Neg_Setup_GenSet0 Neg_r16_IOPairs_GenSet0
begin

locale neg_r16_test = execution_context + strata_rules_neg
begin
...
lemma is_manual_neg_r16 [simp]:
  shows "is_manual assembly semantics (Unary (IS_8088 Neg)     (Storage (Reg (General Sixteen r_1 )))) = False"
