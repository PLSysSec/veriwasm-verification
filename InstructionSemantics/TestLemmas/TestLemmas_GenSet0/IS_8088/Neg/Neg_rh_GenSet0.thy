...
theory Neg_rh_GenSet0
  imports Neg_Setup_GenSet0 Neg_rh_IOPairs_GenSet0
begin

locale neg_rh_test = execution_context + strata_rules_neg
begin
...
lemma is_manual_neg_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_8088 Neg)     (Storage (Reg (General EightHigh r_1 )))) = False"
