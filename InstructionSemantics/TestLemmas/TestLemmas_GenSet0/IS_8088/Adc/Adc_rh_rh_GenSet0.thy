...
theory Adc_rh_rh_GenSet0
  imports Adc_Setup_GenSet0 Adc_rh_rh_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale adc_rh_rh_test = execution_context + strata_rules_adc
begin
...
lemma is_manual_adc_rh_rh [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Adc) (Reg (General  EightHigh r_1)) (Storage (Reg (General EightHigh r_2)))) = False"
