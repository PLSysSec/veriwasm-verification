...
theory Adc_r64_r64_GenSet0
  imports Adc_Setup_GenSet0 Adc_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale adc_r64_r64_test = execution_context + strata_rules_adc
begin
...
lemma is_manual_adc_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Adc) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
