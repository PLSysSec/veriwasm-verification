...
theory Adc_r16_r16_GenSet0
  imports Adc_Setup_GenSet0 Adc_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale adc_r16_r16_test = execution_context + strata_rules_adc
begin
...
lemma is_manual_adc_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Adc) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
