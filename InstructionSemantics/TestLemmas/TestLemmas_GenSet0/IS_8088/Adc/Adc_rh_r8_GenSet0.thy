...
theory Adc_rh_r8_GenSet0
  imports Adc_Setup_GenSet0 Adc_rh_r8_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale adc_rh_r8_test = execution_context + strata_rules_adc
begin
...
lemma is_manual_adc_rh_r8 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Adc) (Reg (General  EightHigh r_1)) (Storage (Reg (General EightLow r_2)))) = False"
