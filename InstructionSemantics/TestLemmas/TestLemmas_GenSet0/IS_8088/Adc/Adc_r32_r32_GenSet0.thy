...
theory Adc_r32_r32_GenSet0
  imports Adc_Setup_GenSet0 Adc_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale adc_r32_r32_test = execution_context + strata_rules_adc
begin
...
lemma is_manual_adc_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Adc) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
