...
theory Adc_r8_rh_GenSet0
  imports Adc_Setup_GenSet0 Adc_r8_rh_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale adc_r8_rh_test = execution_context + strata_rules_adc
begin
...
lemma is_manual_adc_r8_rh [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Adc) (Reg (General  EightLow r_1)) (Storage (Reg (General EightHigh r_2)))) = False"
