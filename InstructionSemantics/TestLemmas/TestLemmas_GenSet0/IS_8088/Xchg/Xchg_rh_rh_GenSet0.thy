...
theory Xchg_rh_rh_GenSet0
  imports Xchg_Setup_GenSet0 Xchg_rh_rh_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale xchg_rh_rh_test = execution_context + strata_rules_xchg
begin
...
lemma is_manual_xchg_rh_rh [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Xchg) (Reg (General  EightHigh r_1)) (Storage (Reg (General EightHigh r_2)))) = False"
