...
theory Xchg_r8_rh_GenSet0
  imports Xchg_Setup_GenSet0 Xchg_r8_rh_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale xchg_r8_rh_test = execution_context + strata_rules_xchg
begin
...
lemma is_manual_xchg_r8_rh [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Xchg) (Reg (General  EightLow r_1)) (Storage (Reg (General EightHigh r_2)))) = False"
