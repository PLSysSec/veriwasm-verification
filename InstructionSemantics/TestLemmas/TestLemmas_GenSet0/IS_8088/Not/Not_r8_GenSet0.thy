...
theory Not_r8_GenSet0
  imports Not_Setup_GenSet0 Not_r8_IOPairs_GenSet0
begin

locale not_r8_test = execution_context + strata_rules_not
begin
...
lemma is_manual_not_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_8088 Not)     (Storage (Reg (General EightLow r_1 )))) = False"
