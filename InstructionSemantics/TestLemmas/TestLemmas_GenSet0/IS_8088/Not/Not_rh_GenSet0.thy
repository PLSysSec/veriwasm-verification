...
theory Not_rh_GenSet0
  imports Not_Setup_GenSet0 Not_rh_IOPairs_GenSet0
begin

locale not_rh_test = execution_context + strata_rules_not
begin
...
lemma is_manual_not_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_8088 Not)     (Storage (Reg (General EightHigh r_1 )))) = False"
