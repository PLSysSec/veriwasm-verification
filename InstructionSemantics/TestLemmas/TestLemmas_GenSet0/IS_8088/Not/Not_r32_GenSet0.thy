...
theory Not_r32_GenSet0
  imports Not_Setup_GenSet0 Not_r32_IOPairs_GenSet0
begin

locale not_r32_test = execution_context + strata_rules_not
begin
...
lemma is_manual_not_r32 [simp]:
  shows "is_manual assembly semantics (Unary (IS_8088 Not)     (Storage (Reg (General ThirtyTwo r_1 )))) = False"
