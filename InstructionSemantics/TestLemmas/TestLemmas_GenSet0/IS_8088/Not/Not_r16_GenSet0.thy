...
theory Not_r16_GenSet0
  imports Not_Setup_GenSet0 Not_r16_IOPairs_GenSet0
begin

locale not_r16_test = execution_context + strata_rules_not
begin
...
lemma is_manual_not_r16 [simp]:
  shows "is_manual assembly semantics (Unary (IS_8088 Not)     (Storage (Reg (General Sixteen r_1 )))) = False"
