...
theory Not_r64_GenSet0
  imports Not_Setup_GenSet0 Not_r64_IOPairs_GenSet0
begin

locale not_r64_test = execution_context + strata_rules_not
begin
...
lemma is_manual_not_r64 [simp]:
  shows "is_manual assembly semantics (Unary (IS_8088 Not)     (Storage (Reg (General SixtyFour r_1 )))) = False"
