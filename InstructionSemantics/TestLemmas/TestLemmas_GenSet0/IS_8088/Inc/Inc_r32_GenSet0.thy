...
theory Inc_r32_GenSet0
  imports Inc_Setup_GenSet0 Inc_r32_IOPairs_GenSet0
begin

locale inc_r32_test = execution_context + strata_rules_inc
begin
...
lemma is_manual_inc_r32 [simp]:
  shows "is_manual assembly semantics (Unary (IS_8088 Inc)     (Storage (Reg (General ThirtyTwo r_1 )))) = False"
