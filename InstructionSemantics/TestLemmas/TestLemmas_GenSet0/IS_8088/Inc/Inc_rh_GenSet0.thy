...
theory Inc_rh_GenSet0
  imports Inc_Setup_GenSet0 Inc_rh_IOPairs_GenSet0
begin

locale inc_rh_test = execution_context + strata_rules_inc
begin
...
lemma is_manual_inc_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_8088 Inc)     (Storage (Reg (General EightHigh r_1 )))) = False"
