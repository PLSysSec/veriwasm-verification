...
theory Inc_r16_GenSet0
  imports Inc_Setup_GenSet0 Inc_r16_IOPairs_GenSet0
begin

locale inc_r16_test = execution_context + strata_rules_inc
begin
...
lemma is_manual_inc_r16 [simp]:
  shows "is_manual assembly semantics (Unary (IS_8088 Inc)     (Storage (Reg (General Sixteen r_1 )))) = False"
