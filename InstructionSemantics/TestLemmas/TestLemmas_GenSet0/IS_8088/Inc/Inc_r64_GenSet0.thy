...
theory Inc_r64_GenSet0
  imports Inc_Setup_GenSet0 Inc_r64_IOPairs_GenSet0
begin

locale inc_r64_test = execution_context + strata_rules_inc
begin
...
lemma is_manual_inc_r64 [simp]:
  shows "is_manual assembly semantics (Unary (IS_8088 Inc)     (Storage (Reg (General SixtyFour r_1 )))) = False"
