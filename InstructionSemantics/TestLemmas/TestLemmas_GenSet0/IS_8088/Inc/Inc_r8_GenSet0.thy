...
theory Inc_r8_GenSet0
  imports Inc_Setup_GenSet0 Inc_r8_IOPairs_GenSet0
begin

locale inc_r8_test = execution_context + strata_rules_inc
begin
...
lemma is_manual_inc_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_8088 Inc)     (Storage (Reg (General EightLow r_1 )))) = False"
