...
theory Sub_rh_rh_GenSet0
  imports Sub_Setup_GenSet0 Sub_rh_rh_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale sub_rh_rh_test = execution_context + strata_rules_sub
begin
...
lemma is_manual_sub_rh_rh [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Sub) (Reg (General  EightHigh r_1)) (Storage (Reg (General EightHigh r_2)))) = False"
