...
theory Sub_rh_r8_GenSet0
  imports Sub_Setup_GenSet0 Sub_rh_r8_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale sub_rh_r8_test = execution_context + strata_rules_sub
begin
...
lemma is_manual_sub_rh_r8 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Sub) (Reg (General  EightHigh r_1)) (Storage (Reg (General EightLow r_2)))) = False"
