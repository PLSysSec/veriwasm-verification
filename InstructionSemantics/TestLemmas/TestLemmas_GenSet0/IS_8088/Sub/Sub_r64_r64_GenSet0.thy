...
theory Sub_r64_r64_GenSet0
  imports Sub_Setup_GenSet0 Sub_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale sub_r64_r64_test = execution_context + strata_rules_sub
begin
...
lemma is_manual_sub_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Sub) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
