...
theory Sub_r16_r16_GenSet0
  imports Sub_Setup_GenSet0 Sub_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale sub_r16_r16_test = execution_context + strata_rules_sub
begin
...
lemma is_manual_sub_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Sub) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
