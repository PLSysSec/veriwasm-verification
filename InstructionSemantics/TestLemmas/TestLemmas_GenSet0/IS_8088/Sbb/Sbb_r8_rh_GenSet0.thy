...
theory Sbb_r8_rh_GenSet0
  imports Sbb_Setup_GenSet0 Sbb_r8_rh_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale sbb_r8_rh_test = execution_context + strata_rules_sbb
begin
...
lemma is_manual_sbb_r8_rh [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Sbb) (Reg (General  EightLow r_1)) (Storage (Reg (General EightHigh r_2)))) = False"
