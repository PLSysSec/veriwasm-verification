...
theory Sbb_r32_r32_GenSet0
  imports Sbb_Setup_GenSet0 Sbb_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale sbb_r32_r32_test = execution_context + strata_rules_sbb
begin
...
lemma is_manual_sbb_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Sbb) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
