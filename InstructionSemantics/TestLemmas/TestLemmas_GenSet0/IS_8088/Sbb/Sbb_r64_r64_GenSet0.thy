...
theory Sbb_r64_r64_GenSet0
  imports Sbb_Setup_GenSet0 Sbb_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale sbb_r64_r64_test = execution_context + strata_rules_sbb
begin
...
lemma is_manual_sbb_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Sbb) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
