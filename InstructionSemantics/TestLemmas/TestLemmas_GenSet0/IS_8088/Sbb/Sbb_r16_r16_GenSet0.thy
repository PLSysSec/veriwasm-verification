...
theory Sbb_r16_r16_GenSet0
  imports Sbb_Setup_GenSet0 Sbb_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale sbb_r16_r16_test = execution_context + strata_rules_sbb
begin
...
lemma is_manual_sbb_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Sbb) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
