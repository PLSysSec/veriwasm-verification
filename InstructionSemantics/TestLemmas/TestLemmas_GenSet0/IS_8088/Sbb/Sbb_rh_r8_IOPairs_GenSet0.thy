...
theory Sbb_rh_r8_IOPairs_GenSet0
...
abbreviation Test2_dst_end :: "DstSize word list" where   "Test2_dst_end   \<equiv> [0xbdcf1da526975089]" 
...
abbreviation Test2_flags_end :: "(flag \<times> bool) list" where "Test2_flags_end \<equiv> [(flag_cf, False),(flag_pf, True),(flag_zf, False),(flag_sf, False),(flag_of, True)]"
...
abbreviation Test5_dst_end :: "DstSize word list" where   "Test5_dst_end   \<equiv> [0x98339fd3ba52e501]" 
