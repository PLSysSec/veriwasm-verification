...
theory Sbb_rh_rh_GenSet0
  imports Sbb_Setup_GenSet0 Sbb_rh_rh_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale sbb_rh_rh_test = execution_context + strata_rules_sbb
begin
...
lemma is_manual_sbb_rh_rh [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Sbb) (Reg (General  EightHigh r_1)) (Storage (Reg (General EightHigh r_2)))) = False"
