...
theory Test_r16_r16_GenSet0
  imports Test_Setup_GenSet0 Test_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale test_r16_r16_test = execution_context + strata_rules_test
begin
...
lemma is_manual_test_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Test) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
