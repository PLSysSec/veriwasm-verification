...
theory Test_r64_r64_IOPairs_GenSet0
...
abbreviation Test2_flags_end :: "(flag \<times> bool) list" where "Test2_flags_end \<equiv> [(flag_cf, False),(flag_pf, undefined),(flag_zf, False),(flag_sf, True),(flag_of, False)]"
