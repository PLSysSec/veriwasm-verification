...
theory Test_r8_r8_IOPairs_GenSet0
...
abbreviation Test5_flags_end :: "(flag \<times> bool) list" where "Test5_flags_end \<equiv> [(flag_cf, False),(flag_pf, undefined),(flag_zf, True),(flag_sf, False),(flag_of, False)]"
