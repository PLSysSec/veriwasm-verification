...
theory Test_r32_r32_GenSet0
  imports Test_Setup_GenSet0 Test_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale test_r32_r32_test = execution_context + strata_rules_test
begin
...
lemma is_manual_test_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Test) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
