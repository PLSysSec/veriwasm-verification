...
theory Test_rh_rh_GenSet0
  imports Test_Setup_GenSet0 Test_rh_rh_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale test_rh_rh_test = execution_context + strata_rules_test
begin
...
lemma is_manual_test_rh_rh [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Test) (Reg (General  EightHigh r_1)) (Storage (Reg (General EightHigh r_2)))) = False"
