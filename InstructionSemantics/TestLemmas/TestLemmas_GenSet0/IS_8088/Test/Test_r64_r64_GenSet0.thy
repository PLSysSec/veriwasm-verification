...
theory Test_r64_r64_GenSet0
  imports Test_Setup_GenSet0 Test_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale test_r64_r64_test = execution_context + strata_rules_test
begin
...
lemma is_manual_test_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Test) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
