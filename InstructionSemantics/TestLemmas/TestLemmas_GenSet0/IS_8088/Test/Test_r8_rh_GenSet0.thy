...
theory Test_r8_rh_GenSet0
  imports Test_Setup_GenSet0 Test_r8_rh_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale test_r8_rh_test = execution_context + strata_rules_test
begin
...
lemma is_manual_test_r8_rh [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Test) (Reg (General  EightLow r_1)) (Storage (Reg (General EightHigh r_2)))) = False"
