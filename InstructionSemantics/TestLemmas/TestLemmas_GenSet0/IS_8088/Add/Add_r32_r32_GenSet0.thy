...
theory Add_r32_r32_GenSet0
  imports Add_Setup_GenSet0 Add_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale add_r32_r32_test = execution_context + strata_rules_add
begin
...
lemma is_manual_add_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Add) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
