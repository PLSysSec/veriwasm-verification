...
theory Add_r16_r16_GenSet0
  imports Add_Setup_GenSet0 Add_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale add_r16_r16_test = execution_context + strata_rules_add
begin
...
lemma is_manual_add_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Add) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
