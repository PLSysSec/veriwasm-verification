...
theory Add_rh_rh_GenSet0
  imports Add_Setup_GenSet0 Add_rh_rh_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale add_rh_rh_test = execution_context + strata_rules_add
begin
...
lemma is_manual_add_rh_rh [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Add) (Reg (General  EightHigh r_1)) (Storage (Reg (General EightHigh r_2)))) = False"
