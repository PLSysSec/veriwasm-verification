...
theory Add_rh_r8_GenSet0
  imports Add_Setup_GenSet0 Add_rh_r8_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale add_rh_r8_test = execution_context + strata_rules_add
begin
...
lemma is_manual_add_rh_r8 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Add) (Reg (General  EightHigh r_1)) (Storage (Reg (General EightLow r_2)))) = False"
