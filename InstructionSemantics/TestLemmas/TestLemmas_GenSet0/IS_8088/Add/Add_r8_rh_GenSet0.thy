...
theory Add_r8_rh_GenSet0
  imports Add_Setup_GenSet0 Add_r8_rh_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale add_r8_rh_test = execution_context + strata_rules_add
begin
...
lemma is_manual_add_r8_rh [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Add) (Reg (General  EightLow r_1)) (Storage (Reg (General EightHigh r_2)))) = False"
