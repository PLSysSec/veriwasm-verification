...
theory Add_r64_r64_GenSet0
  imports Add_Setup_GenSet0 Add_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale add_r64_r64_test = execution_context + strata_rules_add
begin
...
lemma is_manual_add_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Add) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
