...
theory Xor_r64_r64_GenSet0
  imports Xor_Setup_GenSet0 Xor_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale xor_r64_r64_test = execution_context + strata_rules_xor
begin
...
lemma is_manual_xor_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Xor) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
