...
theory Xor_rh_r8_GenSet0
  imports Xor_Setup_GenSet0 Xor_rh_r8_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale xor_rh_r8_test = execution_context + strata_rules_xor
begin
...
lemma is_manual_xor_rh_r8 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Xor) (Reg (General  EightHigh r_1)) (Storage (Reg (General EightLow r_2)))) = False"
