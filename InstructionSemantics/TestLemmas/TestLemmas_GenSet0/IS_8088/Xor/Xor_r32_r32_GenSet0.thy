...
theory Xor_r32_r32_GenSet0
  imports Xor_Setup_GenSet0 Xor_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale xor_r32_r32_test = execution_context + strata_rules_xor
begin
...
lemma is_manual_xor_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Xor) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
