...
theory Xor_rh_rh_GenSet0
  imports Xor_Setup_GenSet0 Xor_rh_rh_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale xor_rh_rh_test = execution_context + strata_rules_xor
begin
...
lemma is_manual_xor_rh_rh [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Xor) (Reg (General  EightHigh r_1)) (Storage (Reg (General EightHigh r_2)))) = False"
