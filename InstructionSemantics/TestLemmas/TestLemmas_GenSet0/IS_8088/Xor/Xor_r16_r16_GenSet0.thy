...
theory Xor_r16_r16_GenSet0
  imports Xor_Setup_GenSet0 Xor_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale xor_r16_r16_test = execution_context + strata_rules_xor
begin
...
lemma is_manual_xor_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 Xor) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
