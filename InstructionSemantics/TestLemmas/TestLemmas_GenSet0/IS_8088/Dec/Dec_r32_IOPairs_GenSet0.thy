...
theory Dec_r32_IOPairs_GenSet0
...
abbreviation Test1_dst_end :: "DstSize word list" where   "Test1_dst_end   \<equiv> [0x8d69a99c]" 
abbreviation Test1_src_start :: "SrcSize word list" where "Test1_src_start \<equiv> [0xbf4ac1508d69a99d]"
abbreviation Test1_src_end :: "SrcSize word list" where   "Test1_src_end   \<equiv> [0x8d69a99c]"
...
abbreviation Test2_dst_end :: "DstSize word list" where   "Test2_dst_end   \<equiv> [0x26979888]" 
abbreviation Test2_src_start :: "SrcSize word list" where "Test2_src_start \<equiv> [0xbdcf1da526979889]"
abbreviation Test2_src_end :: "SrcSize word list" where   "Test2_src_end   \<equiv> [0x26979888]"
...
abbreviation Test3_dst_end :: "DstSize word list" where   "Test3_dst_end   \<equiv> [0xab5e3236]" 
abbreviation Test3_src_start :: "SrcSize word list" where "Test3_src_start \<equiv> [0x56049a57ab5e3237]"
abbreviation Test3_src_end :: "SrcSize word list" where   "Test3_src_end   \<equiv> [0xab5e3236]"
...
abbreviation Test3_flags_end :: "(flag \<times> bool) list" where "Test3_flags_end \<equiv> [(flag_cf, False),(flag_pf, True),(flag_zf, False),(flag_sf, True),(flag_of, False)]"
...
abbreviation Test4_dst_end :: "DstSize word list" where   "Test4_dst_end   \<equiv> [0x48a12837]" 
abbreviation Test4_src_start :: "SrcSize word list" where "Test4_src_start \<equiv> [0x38fe914348a12838]"
abbreviation Test4_src_end :: "SrcSize word list" where   "Test4_src_end   \<equiv> [0x48a12837]"
...
abbreviation Test5_dst_end :: "DstSize word list" where   "Test5_dst_end   \<equiv> [0xba52e000]" 
abbreviation Test5_src_start :: "SrcSize word list" where "Test5_src_start \<equiv> [0x98339fd3ba52e001]"
abbreviation Test5_src_end :: "SrcSize word list" where   "Test5_src_end   \<equiv> [0xba52e000]"
