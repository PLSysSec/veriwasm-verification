...
theory Dec_r16_GenSet0
  imports Dec_Setup_GenSet0 Dec_r16_IOPairs_GenSet0
begin

locale dec_r16_test = execution_context + strata_rules_dec
begin
...
lemma is_manual_dec_r16 [simp]:
  shows "is_manual assembly semantics (Unary (IS_8088 Dec)     (Storage (Reg (General Sixteen r_1 )))) = False"
