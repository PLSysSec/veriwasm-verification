...
theory Dec_r32_GenSet0
  imports Dec_Setup_GenSet0 Dec_r32_IOPairs_GenSet0
begin

locale dec_r32_test = execution_context + strata_rules_dec
begin
...
lemma is_manual_dec_r32 [simp]:
  shows "is_manual assembly semantics (Unary (IS_8088 Dec)     (Storage (Reg (General ThirtyTwo r_1 )))) = False"
