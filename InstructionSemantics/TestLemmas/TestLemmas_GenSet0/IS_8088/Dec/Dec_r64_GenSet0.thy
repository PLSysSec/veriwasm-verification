...
theory Dec_r64_GenSet0
  imports Dec_Setup_GenSet0 Dec_r64_IOPairs_GenSet0
begin

locale dec_r64_test = execution_context + strata_rules_dec
begin
...
lemma is_manual_dec_r64 [simp]:
  shows "is_manual assembly semantics (Unary (IS_8088 Dec)     (Storage (Reg (General SixtyFour r_1 )))) = False"
