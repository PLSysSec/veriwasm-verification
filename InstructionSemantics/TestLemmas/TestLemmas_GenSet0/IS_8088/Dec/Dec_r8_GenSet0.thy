...
theory Dec_r8_GenSet0
  imports Dec_Setup_GenSet0 Dec_r8_IOPairs_GenSet0
begin

locale dec_r8_test = execution_context + strata_rules_dec
begin
...
lemma is_manual_dec_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_8088 Dec)     (Storage (Reg (General EightLow r_1 )))) = False"
