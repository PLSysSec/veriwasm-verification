...
theory Dec_rh_GenSet0
  imports Dec_Setup_GenSet0 Dec_rh_IOPairs_GenSet0
begin

locale dec_rh_test = execution_context + strata_rules_dec
begin
...
lemma is_manual_dec_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_8088 Dec)     (Storage (Reg (General EightHigh r_1 )))) = False"
