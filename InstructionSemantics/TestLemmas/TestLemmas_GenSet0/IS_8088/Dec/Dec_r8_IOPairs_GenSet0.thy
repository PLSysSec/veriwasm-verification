...
abbreviation Test5_flags_end :: "(flag \<times> bool) list" where "Test5_flags_end \<equiv> [(flag_cf, True),(flag_pf, True),(flag_zf, True),(flag_sf, False),(flag_of, False)]"
