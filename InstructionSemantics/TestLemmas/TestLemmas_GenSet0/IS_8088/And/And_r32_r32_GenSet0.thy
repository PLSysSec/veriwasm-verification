...
theory And_r32_r32_GenSet0
  imports And_Setup_GenSet0 And_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale and_r32_r32_test = execution_context + strata_rules_and
begin
...
lemma is_manual_and_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 And) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
