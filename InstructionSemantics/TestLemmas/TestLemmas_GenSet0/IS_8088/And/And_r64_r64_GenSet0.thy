...
theory And_r64_r64_GenSet0
  imports And_Setup_GenSet0 And_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale and_r64_r64_test = execution_context + strata_rules_and
begin
...
lemma is_manual_and_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 And) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
