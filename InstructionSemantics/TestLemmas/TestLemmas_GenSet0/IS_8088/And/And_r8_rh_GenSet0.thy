...
theory And_r8_rh_GenSet0
  imports And_Setup_GenSet0 And_r8_rh_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale and_r8_rh_test = execution_context + strata_rules_and
begin
...
lemma is_manual_and_r8_rh [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 And) (Reg (General  EightLow r_1)) (Storage (Reg (General EightHigh r_2)))) = False"
