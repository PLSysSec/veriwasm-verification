...
theory And_r16_r16_GenSet0
  imports And_Setup_GenSet0 And_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale and_r16_r16_test = execution_context + strata_rules_and
begin
...
lemma is_manual_and_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 And) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
