...
theory And_rh_rh_GenSet0
  imports And_Setup_GenSet0 And_rh_rh_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale and_rh_rh_test = execution_context + strata_rules_and
begin
...
lemma is_manual_and_rh_rh [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 And) (Reg (General  EightHigh r_1)) (Storage (Reg (General EightHigh r_2)))) = False"
