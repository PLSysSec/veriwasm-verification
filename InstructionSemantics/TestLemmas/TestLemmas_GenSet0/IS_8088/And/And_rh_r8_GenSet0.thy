...
theory And_rh_r8_GenSet0
  imports And_Setup_GenSet0 And_rh_r8_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale and_rh_r8_test = execution_context + strata_rules_and
begin
...
lemma is_manual_and_rh_r8 [simp]:
  shows "is_manual assembly semantics (Binary (IS_8088 And) (Reg (General  EightHigh r_1)) (Storage (Reg (General EightLow r_2)))) = False"
