...
theory Nop_r16_GenSet0
  imports Nop_Setup_GenSet0 Nop_r16_IOPairs_GenSet0
begin

locale nop_r16_test = execution_context + strata_rules_nop
begin
...
lemma is_manual_nop_r16 [simp]:
  shows "is_manual assembly semantics (Unary (IS_8088 Nop)     (Storage (Reg (General Sixteen r_1 )))) = False"
