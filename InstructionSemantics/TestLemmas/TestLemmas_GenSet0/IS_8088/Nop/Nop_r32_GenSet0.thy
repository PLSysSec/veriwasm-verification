...
theory Nop_r32_GenSet0
  imports Nop_Setup_GenSet0 Nop_r32_IOPairs_GenSet0
begin

locale nop_r32_test = execution_context + strata_rules_nop
begin
...
lemma is_manual_nop_r32 [simp]:
  shows "is_manual assembly semantics (Unary (IS_8088 Nop)     (Storage (Reg (General ThirtyTwo r_1 )))) = False"
