...
theory Cmpxchg_r16_r16_GenSet0
  imports Cmpxchg_Setup_GenSet0 Cmpxchg_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmpxchg_r16_r16_test = execution_context + strata_rules_cmpxchg
begin
...
lemma is_manual_cmpxchg_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_80486 Cmpxchg) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
