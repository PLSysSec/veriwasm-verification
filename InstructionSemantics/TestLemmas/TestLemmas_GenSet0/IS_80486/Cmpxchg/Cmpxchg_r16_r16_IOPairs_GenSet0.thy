...
theory Cmpxchg_r16_r16_IOPairs_GenSet0
...
abbreviation Test1_xtra_regs_end ::  "(register_mnemonic \<times> 64 word) list"   where "Test1_xtra_regs_end    \<equiv> [(rax,0x33c411e159c9a99d)]"
...
abbreviation Test2_flags_end :: "(flag \<times> bool) list" where "Test2_flags_end \<equiv> [(flag_cf, True),(flag_pf, undefined),(flag_zf, False),(flag_sf, False),(flag_of, False)]"
...
abbreviation Test2_xtra_regs_end ::  "(register_mnemonic \<times> 64 word) list"   where "Test2_xtra_regs_end    \<equiv> [(rax,0x903d7060777c9889)]"
...
abbreviation Test3_xtra_regs_end ::  "(register_mnemonic \<times> 64 word) list"   where "Test3_xtra_regs_end    \<equiv> [(rax,0x274428fa66073237)]"
...
abbreviation Test4_flags_end :: "(flag \<times> bool) list" where "Test4_flags_end \<equiv> [(flag_cf, False),(flag_pf, undefined),(flag_zf, False),(flag_sf, True),(flag_of, False)]"
...
abbreviation Test4_xtra_regs_end ::  "(register_mnemonic \<times> 64 word) list"   where "Test4_xtra_regs_end    \<equiv> [(rax,0x2f579ae04cc12838)]"
...
abbreviation Test5_flags_end :: "(flag \<times> bool) list" where "Test5_flags_end \<equiv> [(flag_cf, True),(flag_pf, undefined),(flag_zf, False),(flag_sf, True),(flag_of, False)]"
...
abbreviation Test5_xtra_regs_end ::  "(register_mnemonic \<times> 64 word) list"   where "Test5_xtra_regs_end    \<equiv> [(rax,0x15866f61fc3fe001)]"
