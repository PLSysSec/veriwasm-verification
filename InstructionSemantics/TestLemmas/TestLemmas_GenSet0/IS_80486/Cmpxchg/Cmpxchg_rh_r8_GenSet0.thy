...
theory Cmpxchg_rh_r8_GenSet0
  imports Cmpxchg_Setup_GenSet0 Cmpxchg_rh_r8_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmpxchg_rh_r8_test = execution_context + strata_rules_cmpxchg
begin
...
lemma is_manual_cmpxchg_rh_r8 [simp]:
  shows "is_manual assembly semantics (Binary (IS_80486 Cmpxchg) (Reg (General  EightHigh r_1)) (Storage (Reg (General EightLow r_2)))) = False"
