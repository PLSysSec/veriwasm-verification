...
theory Cmpxchg_r64_r64_GenSet0
  imports Cmpxchg_Setup_GenSet0 Cmpxchg_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale cmpxchg_r64_r64_test = execution_context + strata_rules_cmpxchg
begin
...
lemma is_manual_cmpxchg_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_80486 Cmpxchg) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
