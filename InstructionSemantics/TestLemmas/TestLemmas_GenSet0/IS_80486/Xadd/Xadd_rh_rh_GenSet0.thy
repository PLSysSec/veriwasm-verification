...
theory Xadd_rh_rh_GenSet0
  imports Xadd_Setup_GenSet0 Xadd_rh_rh_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale xadd_rh_rh_test = execution_context + strata_rules_xadd
begin
...
lemma is_manual_xadd_rh_rh [simp]:
  shows "is_manual assembly semantics (Binary (IS_80486 Xadd) (Reg (General  EightHigh r_1)) (Storage (Reg (General EightHigh r_2)))) = False"
