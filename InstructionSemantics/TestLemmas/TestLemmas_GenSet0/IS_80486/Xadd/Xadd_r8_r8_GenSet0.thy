...
theory Xadd_r8_r8_GenSet0
  imports Xadd_Setup_GenSet0 Xadd_r8_r8_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale xadd_r8_r8_test = execution_context + strata_rules_xadd
begin
...
lemma is_manual_xadd_r8_r8 [simp]:
  shows "is_manual assembly semantics (Binary (IS_80486 Xadd) (Reg (General  EightLow r_1)) (Storage (Reg (General EightLow r_2)))) = False"
