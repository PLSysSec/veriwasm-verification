...
theory Xadd_r8_rh_IOPairs_GenSet0
...
abbreviation Test1_dst_end :: "DstSize word list" where   "Test1_dst_end   \<equiv> [0xbf4ac1508d69a92c]" 
abbreviation Test1_src_start :: "SrcSize word list" where "Test1_src_start \<equiv> [0x60164718ee078f05]"
abbreviation Test1_src_end :: "SrcSize word list" where   "Test1_src_end   \<equiv> [0x60164718ee079d05]"
...
abbreviation Test2_dst_end :: "DstSize word list" where   "Test2_dst_end   \<equiv> [0xbdcf1da52697983c]" 
abbreviation Test2_src_start :: "SrcSize word list" where "Test2_src_start \<equiv> [0xd77d34245201b347]"
abbreviation Test2_src_end :: "SrcSize word list" where   "Test2_src_end   \<equiv> [0xd77d342452018947]"
...
abbreviation Test2_flags_end :: "(flag \<times> bool) list" where "Test2_flags_end \<equiv> [(flag_cf, True),(flag_pf, True),(flag_zf, False),(flag_sf, False),(flag_of, True)]"
...
abbreviation Test3_dst_end :: "DstSize word list" where   "Test3_dst_end   \<equiv> [0x56049a57ab5e32ea]" 
abbreviation Test3_src_start :: "SrcSize word list" where "Test3_src_start \<equiv> [0x4132376664cab32b]"
abbreviation Test3_src_end :: "SrcSize word list" where   "Test3_src_end   \<equiv> [0x4132376664ca372b]"
...
abbreviation Test4_dst_end :: "DstSize word list" where   "Test4_dst_end   \<equiv> [0x38fe914348a12897]" 
abbreviation Test4_src_start :: "SrcSize word list" where "Test4_src_start \<equiv> [0x8892763970f85f39]"
abbreviation Test4_src_end :: "SrcSize word list" where   "Test4_src_end   \<equiv> [0x8892763970f83839]"
...
abbreviation Test4_flags_end :: "(flag \<times> bool) list" where "Test4_flags_end \<equiv> [(flag_cf, False),(flag_pf, False),(flag_zf, False),(flag_sf, True),(flag_of, True)]"
...
abbreviation Test5_dst_end :: "DstSize word list" where   "Test5_dst_end   \<equiv> [0x98339fd3ba52e0d7]" 
abbreviation Test5_src_start :: "SrcSize word list" where "Test5_src_start \<equiv> [0x6fefb310e4ebd6fa]"
abbreviation Test5_src_end :: "SrcSize word list" where   "Test5_src_end   \<equiv> [0x6fefb310e4eb01fa]"
...
abbreviation Test5_flags_end :: "(flag \<times> bool) list" where "Test5_flags_end \<equiv> [(flag_cf, False),(flag_pf, True),(flag_zf, False),(flag_sf, True),(flag_of, False)]"
