...
theory Xadd_r64_r64_GenSet0
  imports Xadd_Setup_GenSet0 Xadd_r64_r64_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale xadd_r64_r64_test = execution_context + strata_rules_xadd
begin
...
lemma is_manual_xadd_r64_r64 [simp]:
  shows "is_manual assembly semantics (Binary (IS_80486 Xadd) (Reg (General  SixtyFour r_1)) (Storage (Reg (General SixtyFour r_2)))) = False"
