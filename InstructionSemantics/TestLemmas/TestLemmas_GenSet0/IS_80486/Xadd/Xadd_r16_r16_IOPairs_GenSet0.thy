...
theory Xadd_r16_r16_IOPairs_GenSet0
...
abbreviation Test1_dst_end :: "DstSize word list" where   "Test1_dst_end   \<equiv> [0xbf4ac1508d6938a2]" 
abbreviation Test1_src_start :: "SrcSize word list" where "Test1_src_start \<equiv> [0x60164718ee078f05]"
abbreviation Test1_src_end :: "SrcSize word list" where   "Test1_src_end   \<equiv> [0x60164718ee07a99d]"
...
abbreviation Test1_flags_end :: "(flag \<times> bool) list" where "Test1_flags_end \<equiv> [(flag_cf, True),(flag_pf, False),(flag_zf, False),(flag_sf, False),(flag_of, True)]"
...
abbreviation Test2_dst_end :: "DstSize word list" where   "Test2_dst_end   \<equiv> [0xbdcf1da526974bd0]" 
abbreviation Test2_src_start :: "SrcSize word list" where "Test2_src_start \<equiv> [0xd77d34245201b347]"
abbreviation Test2_src_end :: "SrcSize word list" where   "Test2_src_end   \<equiv> [0xd77d342452019889]"
...
abbreviation Test2_flags_end :: "(flag \<times> bool) list" where "Test2_flags_end \<equiv> [(flag_cf, True),(flag_pf, False),(flag_zf, False),(flag_sf, False),(flag_of, True)]"
...
abbreviation Test3_dst_end :: "DstSize word list" where   "Test3_dst_end   \<equiv> [0x56049a57ab5ee562]" 
abbreviation Test3_src_start :: "SrcSize word list" where "Test3_src_start \<equiv> [0x4132376664cab32b]"
abbreviation Test3_src_end :: "SrcSize word list" where   "Test3_src_end   \<equiv> [0x4132376664ca3237]"
...
abbreviation Test3_flags_end :: "(flag \<times> bool) list" where "Test3_flags_end \<equiv> [(flag_cf, False),(flag_pf, False),(flag_zf, False),(flag_sf, True),(flag_of, False)]"
...
abbreviation Test4_dst_end :: "DstSize word list" where   "Test4_dst_end   \<equiv> [0x38fe914348a18771]" 
abbreviation Test4_src_start :: "SrcSize word list" where "Test4_src_start \<equiv> [0x8892763970f85f39]"
abbreviation Test4_src_end :: "SrcSize word list" where   "Test4_src_end   \<equiv> [0x8892763970f82838]"
...
abbreviation Test4_flags_end :: "(flag \<times> bool) list" where "Test4_flags_end \<equiv> [(flag_cf, False),(flag_pf, True),(flag_zf, False),(flag_sf, True),(flag_of, True)]"
...
abbreviation Test5_dst_end :: "DstSize word list" where   "Test5_dst_end   \<equiv> [0x98339fd3ba52b6fb]" 
abbreviation Test5_src_start :: "SrcSize word list" where "Test5_src_start \<equiv> [0x6fefb310e4ebd6fa]"
abbreviation Test5_src_end :: "SrcSize word list" where   "Test5_src_end   \<equiv> [0x6fefb310e4ebe001]"
