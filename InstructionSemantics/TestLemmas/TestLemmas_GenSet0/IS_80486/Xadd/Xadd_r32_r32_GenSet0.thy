...
theory Xadd_r32_r32_GenSet0
  imports Xadd_Setup_GenSet0 Xadd_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale xadd_r32_r32_test = execution_context + strata_rules_xadd
begin
...
lemma is_manual_xadd_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_80486 Xadd) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
