...
theory Xadd_r16_r16_GenSet0
  imports Xadd_Setup_GenSet0 Xadd_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale xadd_r16_r16_test = execution_context + strata_rules_xadd
begin
...
lemma is_manual_xadd_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_80486 Xadd) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
