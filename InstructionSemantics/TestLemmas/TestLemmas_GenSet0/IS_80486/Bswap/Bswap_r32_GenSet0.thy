...
theory Bswap_r32_GenSet0
  imports Bswap_Setup_GenSet0 Bswap_r32_IOPairs_GenSet0
begin

locale bswap_r32_test = execution_context + strata_rules_bswap
begin
...
lemma is_manual_bswap_r32 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80486 Bswap)     (Storage (Reg (General ThirtyTwo r_1 )))) = False"
