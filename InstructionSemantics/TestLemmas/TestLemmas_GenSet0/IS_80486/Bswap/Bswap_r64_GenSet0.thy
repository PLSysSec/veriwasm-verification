...
theory Bswap_r64_GenSet0
  imports Bswap_Setup_GenSet0 Bswap_r64_IOPairs_GenSet0
begin

locale bswap_r64_test = execution_context + strata_rules_bswap
begin
...
lemma is_manual_bswap_r64 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80486 Bswap)     (Storage (Reg (General SixtyFour r_1 )))) = False"
