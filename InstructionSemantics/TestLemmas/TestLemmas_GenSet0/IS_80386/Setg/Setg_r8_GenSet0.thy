...
theory Setg_r8_GenSet0
  imports Setg_Setup_GenSet0 Setg_r8_IOPairs_GenSet0
begin

locale setg_r8_test = execution_context + strata_rules_setg
begin
...
lemma is_manual_setg_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setg)     (Storage (Reg (General EightLow r_1 )))) = False"
