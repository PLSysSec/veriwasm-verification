...
theory Setg_rh_GenSet0
  imports Setg_Setup_GenSet0 Setg_rh_IOPairs_GenSet0
begin

locale setg_rh_test = execution_context + strata_rules_setg
begin
...
lemma is_manual_setg_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setg)     (Storage (Reg (General EightHigh r_1 )))) = False"
