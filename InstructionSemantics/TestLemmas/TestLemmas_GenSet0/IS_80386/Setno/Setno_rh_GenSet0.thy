...
theory Setno_rh_GenSet0
  imports Setno_Setup_GenSet0 Setno_rh_IOPairs_GenSet0
begin

locale setno_rh_test = execution_context + strata_rules_setno
begin
...
lemma is_manual_setno_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setno)     (Storage (Reg (General EightHigh r_1 )))) = False"
