...
theory Setno_r8_GenSet0
  imports Setno_Setup_GenSet0 Setno_r8_IOPairs_GenSet0
begin

locale setno_r8_test = execution_context + strata_rules_setno
begin
...
lemma is_manual_setno_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setno)     (Storage (Reg (General EightLow r_1 )))) = False"
