...
theory Setnl_r8_GenSet0
  imports Setnl_Setup_GenSet0 Setnl_r8_IOPairs_GenSet0
begin

locale setnl_r8_test = execution_context + strata_rules_setnl
begin
...
lemma is_manual_setnl_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setnl)     (Storage (Reg (General EightLow r_1 )))) = False"
