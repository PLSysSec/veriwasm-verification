...
theory Setnl_rh_GenSet0
  imports Setnl_Setup_GenSet0 Setnl_rh_IOPairs_GenSet0
begin

locale setnl_rh_test = execution_context + strata_rules_setnl
begin
...
lemma is_manual_setnl_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setnl)     (Storage (Reg (General EightHigh r_1 )))) = False"
