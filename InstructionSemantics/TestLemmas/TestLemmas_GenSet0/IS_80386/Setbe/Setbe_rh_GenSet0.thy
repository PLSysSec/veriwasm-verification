...
theory Setbe_rh_GenSet0
  imports Setbe_Setup_GenSet0 Setbe_rh_IOPairs_GenSet0
begin

locale setbe_rh_test = execution_context + strata_rules_setbe
begin
...
lemma is_manual_setbe_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setbe)     (Storage (Reg (General EightHigh r_1 )))) = False"
