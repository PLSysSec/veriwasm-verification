...
theory Setbe_r8_GenSet0
  imports Setbe_Setup_GenSet0 Setbe_r8_IOPairs_GenSet0
begin

locale setbe_r8_test = execution_context + strata_rules_setbe
begin
...
lemma is_manual_setbe_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setbe)     (Storage (Reg (General EightLow r_1 )))) = False"
