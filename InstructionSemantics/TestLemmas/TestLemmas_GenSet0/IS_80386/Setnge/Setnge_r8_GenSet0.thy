...
theory Setnge_r8_GenSet0
  imports Setnge_Setup_GenSet0 Setnge_r8_IOPairs_GenSet0
begin

locale setnge_r8_test = execution_context + strata_rules_setnge
begin
...
lemma is_manual_setnge_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setnge)     (Storage (Reg (General EightLow r_1 )))) = False"
