...
theory Setnge_r8_IOPairs_GenSet0
...
abbreviation Test1_dst_end :: "DstSize word list" where   "Test1_dst_end   \<equiv> [0xbf4ac1508d69a900]" 
abbreviation Test1_src_start :: "SrcSize word list" where "Test1_src_start \<equiv> [0xbf4ac1508d69a99d]"
abbreviation Test1_src_end :: "SrcSize word list" where   "Test1_src_end   \<equiv> [0xbf4ac1508d69a900]"
...
abbreviation Test1_flags_end :: "(flag \<times> bool) list" where "Test1_flags_end \<equiv> [(flag_cf, False),(flag_pf, True),(flag_zf, True),(flag_sf, True),(flag_of, True)]"
...
abbreviation Test2_dst_end :: "DstSize word list" where   "Test2_dst_end   \<equiv> [0xbdcf1da526979801]" 
abbreviation Test2_src_start :: "SrcSize word list" where "Test2_src_start \<equiv> [0xbdcf1da526979889]"
abbreviation Test2_src_end :: "SrcSize word list" where   "Test2_src_end   \<equiv> [0xbdcf1da526979801]"
...
abbreviation Test2_flags_end :: "(flag \<times> bool) list" where "Test2_flags_end \<equiv> [(flag_cf, True),(flag_pf, True),(flag_zf, True),(flag_sf, False),(flag_of, True)]"
...
abbreviation Test3_dst_end :: "DstSize word list" where   "Test3_dst_end   \<equiv> [0x56049a57ab5e3201]" 
abbreviation Test3_src_start :: "SrcSize word list" where "Test3_src_start \<equiv> [0x56049a57ab5e3237]"
abbreviation Test3_src_end :: "SrcSize word list" where   "Test3_src_end   \<equiv> [0x56049a57ab5e3201]"
...
abbreviation Test3_flags_end :: "(flag \<times> bool) list" where "Test3_flags_end \<equiv> [(flag_cf, False),(flag_pf, False),(flag_zf, False),(flag_sf, False),(flag_of, True)]"
...
abbreviation Test4_dst_end :: "DstSize word list" where   "Test4_dst_end   \<equiv> [0x38fe914348a12801]" 
abbreviation Test4_src_start :: "SrcSize word list" where "Test4_src_start \<equiv> [0x38fe914348a12838]"
abbreviation Test4_src_end :: "SrcSize word list" where   "Test4_src_end   \<equiv> [0x38fe914348a12801]"
...
abbreviation Test4_flags_end :: "(flag \<times> bool) list" where "Test4_flags_end \<equiv> [(flag_cf, False),(flag_pf, False),(flag_zf, False),(flag_sf, True),(flag_of, False)]"
...
abbreviation Test5_flags_end :: "(flag \<times> bool) list" where "Test5_flags_end \<equiv> [(flag_cf, True),(flag_pf, True),(flag_zf, False),(flag_sf, True),(flag_of, True)]"
