...
theory Setnge_rh_GenSet0
  imports Setnge_Setup_GenSet0 Setnge_rh_IOPairs_GenSet0
begin

locale setnge_rh_test = execution_context + strata_rules_setnge
begin
...
lemma is_manual_setnge_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setnge)     (Storage (Reg (General EightHigh r_1 )))) = False"
