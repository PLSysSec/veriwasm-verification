...
theory Seto_rh_GenSet0
  imports Seto_Setup_GenSet0 Seto_rh_IOPairs_GenSet0
begin

locale seto_rh_test = execution_context + strata_rules_seto
begin
...
lemma is_manual_seto_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Seto)     (Storage (Reg (General EightHigh r_1 )))) = False"
