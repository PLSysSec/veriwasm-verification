...
theory Seto_r8_GenSet0
  imports Seto_Setup_GenSet0 Seto_r8_IOPairs_GenSet0
begin

locale seto_r8_test = execution_context + strata_rules_seto
begin
...
lemma is_manual_seto_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Seto)     (Storage (Reg (General EightLow r_1 )))) = False"
