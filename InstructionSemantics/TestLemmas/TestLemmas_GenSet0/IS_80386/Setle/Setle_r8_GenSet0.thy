...
theory Setle_r8_GenSet0
  imports Setle_Setup_GenSet0 Setle_r8_IOPairs_GenSet0
begin

locale setle_r8_test = execution_context + strata_rules_setle
begin
...
lemma is_manual_setle_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setle)     (Storage (Reg (General EightLow r_1 )))) = False"
