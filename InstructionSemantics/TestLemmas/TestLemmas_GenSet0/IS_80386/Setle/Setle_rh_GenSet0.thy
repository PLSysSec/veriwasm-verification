...
theory Setle_rh_GenSet0
  imports Setle_Setup_GenSet0 Setle_rh_IOPairs_GenSet0
begin

locale setle_rh_test = execution_context + strata_rules_setle
begin
...
lemma is_manual_setle_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setle)     (Storage (Reg (General EightHigh r_1 )))) = False"
