...
theory Setpe_r8_GenSet0
  imports Setpe_Setup_GenSet0 Setpe_r8_IOPairs_GenSet0
begin

locale setpe_r8_test = execution_context + strata_rules_setpe
begin
...
lemma is_manual_setpe_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setpe)     (Storage (Reg (General EightLow r_1 )))) = False"
