...
theory Setpe_rh_GenSet0
  imports Setpe_Setup_GenSet0 Setpe_rh_IOPairs_GenSet0
begin

locale setpe_rh_test = execution_context + strata_rules_setpe
begin
...
lemma is_manual_setpe_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setpe)     (Storage (Reg (General EightHigh r_1 )))) = False"
