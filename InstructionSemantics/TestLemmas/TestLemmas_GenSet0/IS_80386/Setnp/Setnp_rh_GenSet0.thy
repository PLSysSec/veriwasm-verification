...
theory Setnp_rh_GenSet0
  imports Setnp_Setup_GenSet0 Setnp_rh_IOPairs_GenSet0
begin

locale setnp_rh_test = execution_context + strata_rules_setnp
begin
...
lemma is_manual_setnp_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setnp)     (Storage (Reg (General EightHigh r_1 )))) = False"
