...
theory Setnp_r8_GenSet0
  imports Setnp_Setup_GenSet0 Setnp_r8_IOPairs_GenSet0
begin

locale setnp_r8_test = execution_context + strata_rules_setnp
begin
...
lemma is_manual_setnp_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setnp)     (Storage (Reg (General EightLow r_1 )))) = False"
