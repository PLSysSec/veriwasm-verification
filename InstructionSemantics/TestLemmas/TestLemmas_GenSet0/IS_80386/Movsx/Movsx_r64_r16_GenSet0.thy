...
theory Movsx_r64_r16_GenSet0
  imports Movsx_Setup_GenSet0 Movsx_r64_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale movsx_r64_r16_test = execution_context + strata_rules_movsx
begin
...
lemma is_manual_movsx_r64_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_80386 Movsx) (Reg (General  SixtyFour r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
