...
theory Movsx_r16_rh_GenSet0
  imports Movsx_Setup_GenSet0 Movsx_r16_rh_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale movsx_r16_rh_test = execution_context + strata_rules_movsx
begin
...
lemma is_manual_movsx_r16_rh [simp]:
  shows "is_manual assembly semantics (Binary (IS_80386 Movsx) (Reg (General  Sixteen r_1)) (Storage (Reg (General EightHigh r_2)))) = False"
