...
theory Setnb_r8_GenSet0
  imports Setnb_Setup_GenSet0 Setnb_r8_IOPairs_GenSet0
begin

locale setnb_r8_test = execution_context + strata_rules_setnb
begin
...
lemma is_manual_setnb_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setnb)     (Storage (Reg (General EightLow r_1 )))) = False"
