...
theory Setnb_rh_GenSet0
  imports Setnb_Setup_GenSet0 Setnb_rh_IOPairs_GenSet0
begin

locale setnb_rh_test = execution_context + strata_rules_setnb
begin
...
lemma is_manual_setnb_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setnb)     (Storage (Reg (General EightHigh r_1 )))) = False"
