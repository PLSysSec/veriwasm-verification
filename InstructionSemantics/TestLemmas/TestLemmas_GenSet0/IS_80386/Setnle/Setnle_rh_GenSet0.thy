...
theory Setnle_rh_GenSet0
  imports Setnle_Setup_GenSet0 Setnle_rh_IOPairs_GenSet0
begin

locale setnle_rh_test = execution_context + strata_rules_setnle
begin
...
lemma is_manual_setnle_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setnle)     (Storage (Reg (General EightHigh r_1 )))) = False"
