...
theory Setnle_r8_GenSet0
  imports Setnle_Setup_GenSet0 Setnle_r8_IOPairs_GenSet0
begin

locale setnle_r8_test = execution_context + strata_rules_setnle
begin
...
lemma is_manual_setnle_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setnle)     (Storage (Reg (General EightLow r_1 )))) = False"
