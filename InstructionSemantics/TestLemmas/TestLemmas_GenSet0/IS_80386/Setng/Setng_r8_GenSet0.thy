...
theory Setng_r8_GenSet0
  imports Setng_Setup_GenSet0 Setng_r8_IOPairs_GenSet0
begin

locale setng_r8_test = execution_context + strata_rules_setng
begin
...
lemma is_manual_setng_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setng)     (Storage (Reg (General EightLow r_1 )))) = False"
