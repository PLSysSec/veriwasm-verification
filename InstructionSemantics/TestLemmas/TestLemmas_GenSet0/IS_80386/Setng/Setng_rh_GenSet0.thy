...
theory Setng_rh_GenSet0
  imports Setng_Setup_GenSet0 Setng_rh_IOPairs_GenSet0
begin

locale setng_rh_test = execution_context + strata_rules_setng
begin
...
lemma is_manual_setng_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setng)     (Storage (Reg (General EightHigh r_1 )))) = False"
