...
theory Setna_r8_GenSet0
  imports Setna_Setup_GenSet0 Setna_r8_IOPairs_GenSet0
begin

locale setna_r8_test = execution_context + strata_rules_setna
begin
...
lemma is_manual_setna_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setna)     (Storage (Reg (General EightLow r_1 )))) = False"
