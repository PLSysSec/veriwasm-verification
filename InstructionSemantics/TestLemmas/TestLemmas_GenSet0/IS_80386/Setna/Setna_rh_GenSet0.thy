...
theory Setna_rh_GenSet0
  imports Setna_Setup_GenSet0 Setna_rh_IOPairs_GenSet0
begin

locale setna_rh_test = execution_context + strata_rules_setna
begin
...
lemma is_manual_setna_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setna)     (Storage (Reg (General EightHigh r_1 )))) = False"
