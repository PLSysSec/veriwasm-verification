...
theory Setnz_rh_GenSet0
  imports Setnz_Setup_GenSet0 Setnz_rh_IOPairs_GenSet0
begin

locale setnz_rh_test = execution_context + strata_rules_setnz
begin
...
lemma is_manual_setnz_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setnz)     (Storage (Reg (General EightHigh r_1 )))) = False"
