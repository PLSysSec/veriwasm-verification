...
theory Setnz_r8_GenSet0
  imports Setnz_Setup_GenSet0 Setnz_r8_IOPairs_GenSet0
begin

locale setnz_r8_test = execution_context + strata_rules_setnz
begin
...
lemma is_manual_setnz_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setnz)     (Storage (Reg (General EightLow r_1 )))) = False"
