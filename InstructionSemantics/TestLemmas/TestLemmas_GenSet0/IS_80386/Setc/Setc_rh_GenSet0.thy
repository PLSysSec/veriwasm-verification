...
theory Setc_rh_GenSet0
  imports Setc_Setup_GenSet0 Setc_rh_IOPairs_GenSet0
begin

locale setc_rh_test = execution_context + strata_rules_setc
begin
...
lemma is_manual_setc_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setc)     (Storage (Reg (General EightHigh r_1 )))) = False"
