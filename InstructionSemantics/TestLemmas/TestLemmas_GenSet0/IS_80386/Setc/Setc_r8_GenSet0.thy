...
theory Setc_r8_GenSet0
  imports Setc_Setup_GenSet0 Setc_r8_IOPairs_GenSet0
begin

locale setc_r8_test = execution_context + strata_rules_setc
begin
...
lemma is_manual_setc_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setc)     (Storage (Reg (General EightLow r_1 )))) = False"
