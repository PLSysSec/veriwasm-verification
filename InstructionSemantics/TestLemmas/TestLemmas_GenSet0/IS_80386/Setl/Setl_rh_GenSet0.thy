...
theory Setl_rh_GenSet0
  imports Setl_Setup_GenSet0 Setl_rh_IOPairs_GenSet0
begin

locale setl_rh_test = execution_context + strata_rules_setl
begin
...
lemma is_manual_setl_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setl)     (Storage (Reg (General EightHigh r_1 )))) = False"
