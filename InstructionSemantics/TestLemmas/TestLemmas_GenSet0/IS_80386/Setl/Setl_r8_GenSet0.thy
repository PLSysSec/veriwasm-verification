...
theory Setl_r8_GenSet0
  imports Setl_Setup_GenSet0 Setl_r8_IOPairs_GenSet0
begin

locale setl_r8_test = execution_context + strata_rules_setl
begin
...
lemma is_manual_setl_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setl)     (Storage (Reg (General EightLow r_1 )))) = False"
