...
theory Setp_r8_GenSet0
  imports Setp_Setup_GenSet0 Setp_r8_IOPairs_GenSet0
begin

locale setp_r8_test = execution_context + strata_rules_setp
begin
...
lemma is_manual_setp_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setp)     (Storage (Reg (General EightLow r_1 )))) = False"
