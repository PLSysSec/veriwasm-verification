...
theory Setp_rh_GenSet0
  imports Setp_Setup_GenSet0 Setp_rh_IOPairs_GenSet0
begin

locale setp_rh_test = execution_context + strata_rules_setp
begin
...
lemma is_manual_setp_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setp)     (Storage (Reg (General EightHigh r_1 )))) = False"
