...
theory Setpo_r8_GenSet0
  imports Setpo_Setup_GenSet0 Setpo_r8_IOPairs_GenSet0
begin

locale setpo_r8_test = execution_context + strata_rules_setpo
begin
...
lemma is_manual_setpo_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setpo)     (Storage (Reg (General EightLow r_1 )))) = False"
