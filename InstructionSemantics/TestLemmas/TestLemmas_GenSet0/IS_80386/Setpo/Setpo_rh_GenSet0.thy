...
theory Setpo_rh_GenSet0
  imports Setpo_Setup_GenSet0 Setpo_rh_IOPairs_GenSet0
begin

locale setpo_rh_test = execution_context + strata_rules_setpo
begin
...
lemma is_manual_setpo_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setpo)     (Storage (Reg (General EightHigh r_1 )))) = False"
