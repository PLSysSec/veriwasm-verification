...
theory Movzx_r16_r8_GenSet0
  imports Movzx_Setup_GenSet0 Movzx_r16_r8_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale movzx_r16_r8_test = execution_context + strata_rules_movzx
begin
...
lemma is_manual_movzx_r16_r8 [simp]:
  shows "is_manual assembly semantics (Binary (IS_80386 Movzx) (Reg (General  Sixteen r_1)) (Storage (Reg (General EightLow r_2)))) = False"
