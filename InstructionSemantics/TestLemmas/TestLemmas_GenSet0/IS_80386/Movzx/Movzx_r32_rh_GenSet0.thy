...
theory Movzx_r32_rh_GenSet0
  imports Movzx_Setup_GenSet0 Movzx_r32_rh_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale movzx_r32_rh_test = execution_context + strata_rules_movzx
begin
...
lemma is_manual_movzx_r32_rh [simp]:
  shows "is_manual assembly semantics (Binary (IS_80386 Movzx) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General EightHigh r_2)))) = False"
