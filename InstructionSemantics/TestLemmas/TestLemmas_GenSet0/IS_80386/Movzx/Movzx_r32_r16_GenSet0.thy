...
theory Movzx_r32_r16_GenSet0
  imports Movzx_Setup_GenSet0 Movzx_r32_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale movzx_r32_r16_test = execution_context + strata_rules_movzx
begin
...
lemma is_manual_movzx_r32_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_80386 Movzx) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
