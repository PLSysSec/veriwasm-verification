...
theory Movzx_r16_rh_GenSet0
  imports Movzx_Setup_GenSet0 Movzx_r16_rh_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale movzx_r16_rh_test = execution_context + strata_rules_movzx
begin
...
lemma is_manual_movzx_r16_rh [simp]:
  shows "is_manual assembly semantics (Binary (IS_80386 Movzx) (Reg (General  Sixteen r_1)) (Storage (Reg (General EightHigh r_2)))) = False"
