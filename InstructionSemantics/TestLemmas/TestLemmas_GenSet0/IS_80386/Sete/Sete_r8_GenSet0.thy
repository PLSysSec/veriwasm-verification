...
theory Sete_r8_GenSet0
  imports Sete_Setup_GenSet0 Sete_r8_IOPairs_GenSet0
begin

locale sete_r8_test = execution_context + strata_rules_sete
begin
...
lemma is_manual_sete_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Sete)     (Storage (Reg (General EightLow r_1 )))) = False"
