...
theory Sete_rh_GenSet0
  imports Sete_Setup_GenSet0 Sete_rh_IOPairs_GenSet0
begin

locale sete_rh_test = execution_context + strata_rules_sete
begin
...
lemma is_manual_sete_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Sete)     (Storage (Reg (General EightHigh r_1 )))) = False"
