...
theory Setae_r8_GenSet0
  imports Setae_Setup_GenSet0 Setae_r8_IOPairs_GenSet0
begin

locale setae_r8_test = execution_context + strata_rules_setae
begin
...
lemma is_manual_setae_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setae)     (Storage (Reg (General EightLow r_1 )))) = False"
