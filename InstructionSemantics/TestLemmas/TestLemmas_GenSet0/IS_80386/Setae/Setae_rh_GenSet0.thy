...
theory Setae_rh_GenSet0
  imports Setae_Setup_GenSet0 Setae_rh_IOPairs_GenSet0
begin

locale setae_rh_test = execution_context + strata_rules_setae
begin
...
lemma is_manual_setae_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setae)     (Storage (Reg (General EightHigh r_1 )))) = False"
