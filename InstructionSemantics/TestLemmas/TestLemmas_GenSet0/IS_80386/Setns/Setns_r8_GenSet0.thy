...
theory Setns_r8_GenSet0
  imports Setns_Setup_GenSet0 Setns_r8_IOPairs_GenSet0
begin

locale setns_r8_test = execution_context + strata_rules_setns
begin
...
lemma is_manual_setns_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setns)     (Storage (Reg (General EightLow r_1 )))) = False"
