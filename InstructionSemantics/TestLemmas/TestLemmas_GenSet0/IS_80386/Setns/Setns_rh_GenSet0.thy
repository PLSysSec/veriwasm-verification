...
theory Setns_rh_GenSet0
  imports Setns_Setup_GenSet0 Setns_rh_IOPairs_GenSet0
begin

locale setns_rh_test = execution_context + strata_rules_setns
begin
...
lemma is_manual_setns_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setns)     (Storage (Reg (General EightHigh r_1 )))) = False"
