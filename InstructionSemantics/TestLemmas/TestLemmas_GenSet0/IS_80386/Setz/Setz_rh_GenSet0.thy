...
theory Setz_rh_GenSet0
  imports Setz_Setup_GenSet0 Setz_rh_IOPairs_GenSet0
begin

locale setz_rh_test = execution_context + strata_rules_setz
begin
...
lemma is_manual_setz_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setz)     (Storage (Reg (General EightHigh r_1 )))) = False"
