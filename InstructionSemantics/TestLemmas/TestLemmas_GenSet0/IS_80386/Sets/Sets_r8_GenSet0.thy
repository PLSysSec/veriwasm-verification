...
theory Sets_r8_GenSet0
  imports Sets_Setup_GenSet0 Sets_r8_IOPairs_GenSet0
begin

locale sets_r8_test = execution_context + strata_rules_sets
begin
...
lemma is_manual_sets_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Sets)     (Storage (Reg (General EightLow r_1 )))) = False"
