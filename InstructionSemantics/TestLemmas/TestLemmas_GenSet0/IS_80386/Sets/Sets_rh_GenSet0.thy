...
theory Sets_rh_GenSet0
  imports Sets_Setup_GenSet0 Sets_rh_IOPairs_GenSet0
begin

locale sets_rh_test = execution_context + strata_rules_sets
begin
...
lemma is_manual_sets_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Sets)     (Storage (Reg (General EightHigh r_1 )))) = False"
