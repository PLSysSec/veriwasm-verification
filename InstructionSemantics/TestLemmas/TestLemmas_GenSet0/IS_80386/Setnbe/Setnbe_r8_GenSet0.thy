...
theory Setnbe_r8_GenSet0
  imports Setnbe_Setup_GenSet0 Setnbe_r8_IOPairs_GenSet0
begin

locale setnbe_r8_test = execution_context + strata_rules_setnbe
begin
...
lemma is_manual_setnbe_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setnbe)     (Storage (Reg (General EightLow r_1 )))) = False"
