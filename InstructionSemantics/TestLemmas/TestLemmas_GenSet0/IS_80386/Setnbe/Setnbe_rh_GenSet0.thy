...
theory Setnbe_rh_GenSet0
  imports Setnbe_Setup_GenSet0 Setnbe_rh_IOPairs_GenSet0
begin

locale setnbe_rh_test = execution_context + strata_rules_setnbe
begin
...
lemma is_manual_setnbe_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setnbe)     (Storage (Reg (General EightHigh r_1 )))) = False"
