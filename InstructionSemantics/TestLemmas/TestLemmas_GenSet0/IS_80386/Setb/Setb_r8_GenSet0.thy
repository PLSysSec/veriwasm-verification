...
theory Setb_r8_GenSet0
  imports Setb_Setup_GenSet0 Setb_r8_IOPairs_GenSet0
begin

locale setb_r8_test = execution_context + strata_rules_setb
begin
...
lemma is_manual_setb_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setb)     (Storage (Reg (General EightLow r_1 )))) = False"
