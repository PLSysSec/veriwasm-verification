...
theory Setb_rh_GenSet0
  imports Setb_Setup_GenSet0 Setb_rh_IOPairs_GenSet0
begin

locale setb_rh_test = execution_context + strata_rules_setb
begin
...
lemma is_manual_setb_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setb)     (Storage (Reg (General EightHigh r_1 )))) = False"
