...
theory Setge_r8_GenSet0
  imports Setge_Setup_GenSet0 Setge_r8_IOPairs_GenSet0
begin

locale setge_r8_test = execution_context + strata_rules_setge
begin
...
lemma is_manual_setge_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setge)     (Storage (Reg (General EightLow r_1 )))) = False"
