...
theory Setge_rh_GenSet0
  imports Setge_Setup_GenSet0 Setge_rh_IOPairs_GenSet0
begin

locale setge_rh_test = execution_context + strata_rules_setge
begin
...
lemma is_manual_setge_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setge)     (Storage (Reg (General EightHigh r_1 )))) = False"
