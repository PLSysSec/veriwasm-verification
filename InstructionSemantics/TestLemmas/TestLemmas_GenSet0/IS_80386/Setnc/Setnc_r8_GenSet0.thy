...
theory Setnc_r8_GenSet0
  imports Setnc_Setup_GenSet0 Setnc_r8_IOPairs_GenSet0
begin

locale setnc_r8_test = execution_context + strata_rules_setnc
begin
...
lemma is_manual_setnc_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setnc)     (Storage (Reg (General EightLow r_1 )))) = False"
