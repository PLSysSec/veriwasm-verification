...
theory Setnc_rh_GenSet0
  imports Setnc_Setup_GenSet0 Setnc_rh_IOPairs_GenSet0
begin

locale setnc_rh_test = execution_context + strata_rules_setnc
begin
...
lemma is_manual_setnc_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setnc)     (Storage (Reg (General EightHigh r_1 )))) = False"
