...
theory Seta_r8_GenSet0
  imports Seta_Setup_GenSet0 Seta_r8_IOPairs_GenSet0
begin

locale seta_r8_test = execution_context + strata_rules_seta
begin
...
lemma is_manual_seta_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Seta)     (Storage (Reg (General EightLow r_1 )))) = False"
