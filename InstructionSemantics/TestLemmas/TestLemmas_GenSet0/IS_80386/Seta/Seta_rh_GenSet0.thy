...
theory Seta_rh_GenSet0
  imports Seta_Setup_GenSet0 Seta_rh_IOPairs_GenSet0
begin

locale seta_rh_test = execution_context + strata_rules_seta
begin
...
lemma is_manual_seta_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Seta)     (Storage (Reg (General EightHigh r_1 )))) = False"
