...
theory Setnae_r8_GenSet0
  imports Setnae_Setup_GenSet0 Setnae_r8_IOPairs_GenSet0
begin

locale setnae_r8_test = execution_context + strata_rules_setnae
begin
...
lemma is_manual_setnae_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setnae)     (Storage (Reg (General EightLow r_1 )))) = False"
