...
theory Setnae_rh_GenSet0
  imports Setnae_Setup_GenSet0 Setnae_rh_IOPairs_GenSet0
begin

locale setnae_rh_test = execution_context + strata_rules_setnae
begin
...
lemma is_manual_setnae_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setnae)     (Storage (Reg (General EightHigh r_1 )))) = False"
