...
theory Setne_rh_GenSet0
  imports Setne_Setup_GenSet0 Setne_rh_IOPairs_GenSet0
begin

locale setne_rh_test = execution_context + strata_rules_setne
begin
...
lemma is_manual_setne_rh [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setne)     (Storage (Reg (General EightHigh r_1 )))) = False"
