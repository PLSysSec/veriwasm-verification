...
theory Setne_r8_GenSet0
  imports Setne_Setup_GenSet0 Setne_r8_IOPairs_GenSet0
begin

locale setne_r8_test = execution_context + strata_rules_setne
begin
...
lemma is_manual_setne_r8 [simp]:
  shows "is_manual assembly semantics (Unary (IS_80386 Setne)     (Storage (Reg (General EightLow r_1 )))) = False"
