...
theory Popcnt_r32_r32_GenSet0
  imports Popcnt_Setup_GenSet0 Popcnt_r32_r32_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale popcnt_r32_r32_test = execution_context + strata_rules_popcnt
begin
...
lemma is_manual_popcnt_r32_r32 [simp]:
  shows "is_manual assembly semantics (Binary (IS_SSE4_2 Popcnt) (Reg (General  ThirtyTwo r_1)) (Storage (Reg (General ThirtyTwo r_2)))) = False"
