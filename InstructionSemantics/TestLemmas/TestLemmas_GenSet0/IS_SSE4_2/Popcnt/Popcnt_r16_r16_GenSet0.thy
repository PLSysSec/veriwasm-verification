...
theory Popcnt_r16_r16_GenSet0
  imports Popcnt_Setup_GenSet0 Popcnt_r16_r16_IOPairs_GenSet0 "reassembly_setup.Leviathan_Setup"
begin

locale popcnt_r16_r16_test = execution_context + strata_rules_popcnt
begin
...
lemma is_manual_popcnt_r16_r16 [simp]:
  shows "is_manual assembly semantics (Binary (IS_SSE4_2 Popcnt) (Reg (General  Sixteen r_1)) (Storage (Reg (General Sixteen r_2)))) = False"
