...
Definition Plt (x y: positive): Prop := Z.lt (Zpos x) (Zpos y).
...
Proof.
  intros. case (zlt x y); unfold Z.lt, Z.ge; intros.
  unfold Z.min. match goal with | [ H : _ = Lt |- _] => rewrite H end.
  auto.
...
Proof.
  intros. case (zlt y x); unfold Z.lt, Z.ge; intros.
