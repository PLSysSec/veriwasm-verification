theory x86TSO_view_partitioned_2
...
assumes step_consistency:"((view s sc) = (view t sc))  \<longrightarrow> ((view (step s a) sc) = (view (step t a) sc))" (* Step Consistency, sc is security context (thread) *)
...
interpretation tso : view_partitioning gstep_deterministic x86_tso_view x86_tso_thread
